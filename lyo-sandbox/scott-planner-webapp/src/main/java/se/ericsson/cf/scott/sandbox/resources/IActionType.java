...
@OslcName(PlannerReasonerConstants.ACTIONTYPE)
@OslcResourceShape(title = "ActionType Resource Shape", describes = PlannerReasonerConstants.TYPE_ACTIONTYPE)
public interface IActionType
{
    ...
    @OslcPropertyDefinition(PlannerReasonerConstants.PLANNING_NAMSPACE + "hasVariable")
    ...
    @OslcPropertyDefinition(PlannerReasonerConstants.PLANNING_NAMSPACE + "precondition")
    @OslcOccurs(Occurs.ZeroOrOne)
    @OslcValueType(ValueType.Resource)
    @OslcRange({PlannerReasonerConstants.TYPE_PREDICATE})
    @OslcReadOnly(false)
    public Link getPrecondition();

    @OslcName("effect")
    @OslcPropertyDefinition(PlannerReasonerConstants.PLANNING_NAMSPACE + "effect")
    ...
    @OslcName("title")
    @OslcPropertyDefinition(PlannerReasonerConstants.DUBLIN_CORE_NAMSPACE + "title")
