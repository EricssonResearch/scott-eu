...
@OslcName(PlannerReasonerConstants.VARIABLEINSTANCE)
@OslcResourceShape(title = "VariableInstance Resource Shape", describes = PlannerReasonerConstants.TYPE_VARIABLEINSTANCE)
    ...
    implements IVariableInstance
{
    ...
    public static ResourceShape createResourceShape() throws OslcCoreApplicationException, URISyntaxException {
        ...
        PlannerReasonerConstants.PATH_VARIABLEINSTANCE,
    ...
    // End of user code
    @OslcName("value")
    @OslcPropertyDefinition(PlannerReasonerConstants.PLANNING_NAMSPACE + "value")
    ...
    @OslcPropertyDefinition(PlannerReasonerConstants.PLANNING_NAMSPACE + "ppInstanceOf")
    @OslcOccurs(Occurs.ExactlyOne)
    @OslcValueType(ValueType.Resource)
    @OslcRange({PlannerReasonerConstants.TYPE_VARIABLE})
    @OslcReadOnly(false)
    @OslcTitle("")
