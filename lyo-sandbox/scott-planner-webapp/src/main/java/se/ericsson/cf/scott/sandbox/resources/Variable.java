...
@OslcName(PlannerReasonerConstants.VARIABLE)
@OslcResourceShape(title = "Variable Resource Shape", describes = PlannerReasonerConstants.TYPE_VARIABLE)
public class Variable
    extends AbstractResource
    implements IVariable
{
    // Start of user code attributeAnnotation:resourceType
    // End of user code
    private Link resourceType = new Link();
    ...
    public static ResourceShape createResourceShape() throws OslcCoreApplicationException, URISyntaxException {
        ...
        PlannerReasonerConstants.PATH_VARIABLE,
        Variable.class);
    }
    ...
    public String toString(boolean asLocalResource)
    {
        ...
        if (asLocalResource) {
            result = result + "{a Local Variable Resource} - update Variable.toString() to present resource as desired.";
    ...
    @OslcPropertyDefinition(PlannerReasonerConstants.PLANNING_NAMSPACE + "resourceType")
    @OslcOccurs(Occurs.ExactlyOne)
    @OslcValueType(ValueType.Resource)
    @OslcReadOnly(false)
    public Link getResourceType()
    {
        // Start of user code getterInit:resourceType
        // End of user code
        return resourceType;
    }
    ...
    // End of user code
    @OslcName("label")
    @OslcPropertyDefinition(PlannerReasonerConstants.RDFS_NAMSPACE + "label")
    ...
    // Start of user code setterAnnotation:resourceType
    // End of user code
    public void setResourceType(final Link resourceType )
    {
        // Start of user code setterInit:resourceType
        // End of user code
        this.resourceType = resourceType;
    
        // Start of user code setterFinalize:resourceType
        // End of user code
    }
    ...
    static public String resourceTypeToHtmlForCreation (final HttpServletRequest httpServletRequest)
    {
        String s = "";
    
        // Start of user code "Init:resourceTypeToHtmlForCreation(...)"
        // End of user code
    
        s = s + "<label for=\"resourceType\">resourceType: </LABEL>";
    
        // Start of user code "Mid:resourceTypeToHtmlForCreation(...)"
        // End of user code
    
        // Start of user code "Finalize:resourceTypeToHtmlForCreation(...)"
        // End of user code
    ...
    public String resourceTypeToHtml()
    {
        String s = "";
        ...
        try {
            if ((resourceType == null) || (resourceType.getValue() == null)) {
                ...
                s = s + resourceType.getValue().toString();
            }
        } catch (Exception e) {
            e.printStackTrace();
        }
    
        // Start of user code resourceTypetoHtml_finalize
        // End of user code
