...
@OslcName(PlannerReasonerConstants.PLACE)
@OslcResourceShape(title = "Place Resource Shape", describes = PlannerReasonerConstants.TYPE_PLACE)
public class Place
    ...
    implements IPlace
{
    ...
    public static ResourceShape createResourceShape() throws OslcCoreApplicationException, URISyntaxException {
        ...
        PlannerReasonerConstants.PATH_PLACE,
        Place.class);
    }
    ...
    // End of user code
    @OslcName("situatedAt")
    @OslcPropertyDefinition(PlannerReasonerConstants.WAREHOUSE_NAMSPACE + "situatedAt")
    ...
    @OslcPropertyDefinition(PlannerReasonerConstants.WAREHOUSE_NAMSPACE + "isChargingStation")
    @OslcOccurs(Occurs.ExactlyOne)
