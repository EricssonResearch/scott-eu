...
@OslcName(PlannerReasonerConstants.WAYPOINT)
@OslcResourceShape(title = "Waypoint Resource Shape", describes = PlannerReasonerConstants.TYPE_WAYPOINT)
    ...
    implements IWaypoint
{
    ...
    public static ResourceShape createResourceShape() throws OslcCoreApplicationException, URISyntaxException {
        ...
        PlannerReasonerConstants.PATH_WAYPOINT,  
        Waypoint.class);
    }
    ...
    // End of user code
    @OslcName("canMove")
    @OslcPropertyDefinition(PlannerReasonerConstants.WAREHOUSE_NAMSPACE + "canMove")
