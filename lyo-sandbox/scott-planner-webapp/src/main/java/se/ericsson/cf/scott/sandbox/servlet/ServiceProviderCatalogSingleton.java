...
public class ServiceProviderCatalogSingleton
{
    ...
    static
    {
        ...
        serviceProviderCatalog.setTitle("Planner Reasoner catalog");
        ...
        try {
            ...
            for (ServiceProviderInfo serviceProviderInfo : serviceProviderInfos) {
                ...
                if (! serviceProviders.containsKey(identifier)) {
                    ...
                    String title = "robot: " + serviceProviderName + "(" + identifier + ")";
                    String description = "Robot planner provider: " + serviceProviderName + "(" + identifier + ")";
