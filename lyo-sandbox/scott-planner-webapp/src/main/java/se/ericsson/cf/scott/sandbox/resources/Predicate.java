...
@OslcName(PlannerReasonerConstants.PREDICATE)
@OslcResourceShape(title = "Predicate Resource Shape", describes = PlannerReasonerConstants.TYPE_PREDICATE)
    ...
    implements IPredicate
{
    ...
    public static ResourceShape createResourceShape() throws OslcCoreApplicationException, URISyntaxException {
        ...
        PlannerReasonerConstants.PATH_PREDICATE,
        Predicate.class);
    }
