    ...
    implements IPlace
{
    ...
    public Place(final String serviceProviderId, final String placeId)
           throws URISyntaxException
    {
        this (constructURI(serviceProviderId, placeId));
        // Start of user code constructor3
        // End of user code
    }
    
    public static URI constructURI(final String serviceProviderId, final String placeId)
    {
    ...
    public static Link constructLink(final String serviceProviderId, final String placeId , final String label)
    {
        return new Link(constructURI(serviceProviderId, placeId), label);
    }
    
    public static Link constructLink(final String serviceProviderId, final String placeId)
    {
        return new Link(constructURI(serviceProviderId, placeId));
    }
