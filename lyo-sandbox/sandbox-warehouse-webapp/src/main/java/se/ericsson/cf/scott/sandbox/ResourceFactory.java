...
public class ResourceFactory {
    ...
    public ResourceFactory(final String basePath, String spId) {
    ...
    public WhObject buildObject(final String id, final String type, final Link place) {
        try {
            final WhObject object = WarehouseControllerResourcesFactory.createWhObject(spId, id);
            object.setType(type);
    ...
    public Place buildPlace(final String id, final String type, final Link waypoint) {
        try {
            final Place place = WarehouseControllerResourcesFactory.createPlace(spId, id);
            place.setType(type);
    ...
    public Waypoint buildWaypoint(final String id, final Collection<Link> canMove) {
        try {
            final Waypoint waypoint = WarehouseControllerResourcesFactory.createWaypoint(spId, id);
    ...
    public Link wayPointLink(final String id) {
        return WarehouseControllerResourcesFactory.constructLinkForWaypoint(spId, id);
    }

    public Link placeLink(final String id) {
        return WarehouseControllerResourcesFactory.constructLinkForPlace(spId, id);
    }
