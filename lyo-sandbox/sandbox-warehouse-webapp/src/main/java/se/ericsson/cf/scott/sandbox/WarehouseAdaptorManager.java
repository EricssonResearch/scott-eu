...
public class WarehouseAdaptorManager {
    ...
    public static ServiceProviderInfo[] getServiceProviderInfos(
        ...
        serviceProviderInfo.name = "Dummy data";
        serviceProviderInfos = new ServiceProviderInfo[]{serviceProviderInfo};
        // End of user code
        return serviceProviderInfos;
    }

    public static List<WhObject> queryWhObjects(HttpServletRequest httpServletRequest,
    ...
    public static List<Place> queryPlaces(HttpServletRequest httpServletRequest,
            final String serviceProviderId, String where, int page, int limit) {
    ...
    public static List<Robot> queryRobots(HttpServletRequest httpServletRequest,
            final String serviceProviderId, String where, int page, int limit) {
    ...
    public static List<Waypoint> queryWaypoints(HttpServletRequest httpServletRequest,
            final String serviceProviderId, String where, int page, int limit) {
    ...
    public static WhObject getWhObject(HttpServletRequest httpServletRequest,
            final String serviceProviderId, final String whObjectId) {
    ...
    public static Place getPlace(HttpServletRequest httpServletRequest,
            final String serviceProviderId, final String placeId) {
    ...
    public static Robot getRobot(HttpServletRequest httpServletRequest,
            final String serviceProviderId, final String robotId) {
        Robot aResource = null;

        // Start of user code getRobot
        aResource = findResource(getRobots(), getFullURL(httpServletRequest));
        // End of user code
        return aResource;
    }

    public static Waypoint getWaypoint(HttpServletRequest httpServletRequest,
            final String serviceProviderId, final String waypointId) {
