    ...
    implements IWhObject
{
    ...
    public WhObject(final String serviceProviderId, final String whObjectId)
           throws URISyntaxException
    {
        this (constructURI(serviceProviderId, whObjectId));
        // Start of user code constructor3
        // End of user code
    }
    
    public static URI constructURI(final String serviceProviderId, final String whObjectId)
    {
    ...
    public static Link constructLink(final String serviceProviderId, final String whObjectId , final String label)
    {
        return new Link(constructURI(serviceProviderId, whObjectId), label);
    }
    
    public static Link constructLink(final String serviceProviderId, final String whObjectId)
    {
        return new Link(constructURI(serviceProviderId, whObjectId));
    }
