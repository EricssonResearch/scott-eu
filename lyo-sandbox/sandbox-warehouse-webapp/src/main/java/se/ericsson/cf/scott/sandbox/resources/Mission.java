...
@OslcName(WarehouseControllerConstants.MISSION)
@OslcResourceShape(title = "Mission Resource Shape", describes = WarehouseControllerConstants.TYPE_MISSION)
    ...
    implements IMission
{
    ...
    public Mission(final String serviceProviderId, final String missionId)
           throws URISyntaxException
    {
        this (constructURI(serviceProviderId, missionId));
        // Start of user code constructor3
        // End of user code
    }
    
    public static URI constructURI(final String serviceProviderId, final String missionId)
    {
    ...
    public static Link constructLink(final String serviceProviderId, final String missionId , final String label)
    {
        return new Link(constructURI(serviceProviderId, missionId), label);
    }
    
    public static Link constructLink(final String serviceProviderId, final String missionId)
    {
        return new Link(constructURI(serviceProviderId, missionId));
    }
    
    public static ResourceShape createResourceShape() throws OslcCoreApplicationException, URISyntaxException {
        return ResourceShapeFactory.createResourceShape(OSLC4JUtils.getServletURI(),
        OslcConstants.PATH_RESOURCE_SHAPES,
        WarehouseControllerConstants.PATH_MISSION,
        Mission.class);
    }
    ...
    @OslcPropertyDefinition(WarehouseControllerConstants.PLANNING_NAMSPACE + "planningDeadline")
    ...
    // End of user code
    @OslcName("label")
    @OslcPropertyDefinition(WarehouseControllerConstants.RDFS_NAMSPACE + "label")
    ...
    @OslcPropertyDefinition(WarehouseControllerConstants.PLANNING_NAMSPACE + "missionDeadline")
    @OslcOccurs(Occurs.ExactlyOne)
    @OslcValueType(ValueType.DateTime)
    @OslcReadOnly(false)
    ...
    @OslcPropertyDefinition(WarehouseControllerConstants.PLANNING_NAMSPACE + "goalPredicate")
    @OslcOccurs(Occurs.OneOrMany)
    @OslcValueType(ValueType.Resource)
    @OslcRange({WarehouseControllerConstants.TYPE_PREDICATE})
    @OslcReadOnly(false)
    ...
    @OslcPropertyDefinition(WarehouseControllerConstants.PLANNING_NAMSPACE + "initialState")
    @OslcOccurs(Occurs.ExactlyOne)
    @OslcValueType(ValueType.LocalResource)
    @OslcRange({WarehouseControllerConstants.TYPE_PROBLEMSTATE})
    @OslcReadOnly(false)
