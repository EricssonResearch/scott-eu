...
@OslcName(WarehouseControllerConstants.PREDICATE)
@OslcResourceShape(title = "Predicate Resource Shape", describes = WarehouseControllerConstants.TYPE_PREDICATE)
    ...
    implements IPredicate
{
    ...
    public static ResourceShape createResourceShape() throws OslcCoreApplicationException, URISyntaxException {
        ...
        WarehouseControllerConstants.PATH_PREDICATE,  
        Predicate.class);
    }
    ...
    // End of user code
    @OslcName("title")
    @OslcPropertyDefinition(WarehouseControllerConstants.DUBLIN_CORE_NAMSPACE + "title")
