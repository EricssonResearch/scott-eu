...
<%@page import="se.ericsson.cf.scott.sandbox.resources.Fluent"%>
<%--
...
<%
  Fluent aFluent = (Fluent) request.getAttribute("aFluent");
%>
<%--
...
<head>
  ...
  <title><%= aFluent.toString(true) %></title>
...
<div class="container">
    <div class="page-header">
        <h1>Fluent resource</h1>
        <p class="lead">URI:&nbsp;
      <a href="<%= aFluent.getAbout() %>"><%= aFluent.getAbout() %></a>
        </p>
    </div>
        <%--
...
End of user code
        ...
        <div>
          <dl class="row">
            ...
            <dd class="col-sm-9"><%= aFluent.hasVariableToHtml()%></dd>
          </dl>
          <dl class="row">
            <dt  class="col-sm-2 text-right"></dt>
            <dd class="col-sm-9"><%= aFluent.ToHtml()%></dd>
          </dl>
          <dl class="row">
            <dt  class="col-sm-2 text-right"></dt>
            <dd class="col-sm-9"><%= aFluent.ToHtml()%></dd>
