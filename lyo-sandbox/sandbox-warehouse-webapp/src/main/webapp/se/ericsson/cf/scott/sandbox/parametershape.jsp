...
<%@page import="eu.scott.coala.pddl.ParameterShape"%>
<%--
...
<%
  ParameterShape aParameterShape = (ParameterShape) request.getAttribute("aParameterShape");
%>
<%--
...
<head>
  ...
  <title><%= aParameterShape.toString(true) %></title>
...
<div class="container">
    <div class="page-header">
        <h1>ParameterShape resource</h1>
        <p class="lead">URI:&nbsp;
      <a href="<%= aParameterShape.getAbout() %>"><%= aParameterShape.getAbout() %></a>
        </p>
    </div>
        <%--
...
End of user code
        ...
        <div>
          <dl class="row">
            ...
            <dd class="col-sm-9"><%= aParameterShape.typeToHtml()%></dd>
          </dl>
          <dl class="row">
            <dt  class="col-sm-2 text-right">label</dt>
            <dd class="col-sm-9"><%= aParameterShape.labelToHtml()%></dd>
          </dl>
          <dl class="row">
            <dt  class="col-sm-2 text-right">order</dt>
            <dd class="col-sm-9"><%= aParameterShape.orderToHtml()%></dd>
          </dl>
        </div>
      </div>
    </div>
