...
<head>
  ...
  <title><%= aActionType.toString(false) %></title>
...
<div>
        <div>
          <dl class="dl-horizontal">
            <dt></dt>
            <dd><%= aActionType.ToHtml()%></dd>
          </dl>
          <dl class="dl-horizontal">
            <dt>hasVariable</dt>
            <dd><%= aActionType.hasVariableToHtml()%></dd>
          </dl>
          <dl class="dl-horizontal">
            <dt>precondition</dt>
            <dd><%= aActionType.preconditionToHtml()%></dd>
          </dl>
          <dl class="dl-horizontal">
            <dt>effect</dt>
            <dd><%= aActionType.effectToHtml()%></dd>
          </dl>
          <dl class="dl-horizontal">
            <dt></dt>
            <dd><%= aActionType.ToHtml()%></dd>
