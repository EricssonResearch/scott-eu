...
<%
  List<Waypoint> resources = (List<Waypoint>) request.getAttribute("resources");
...
<nav class="navbar navbar-default navbar-fixed-top">
  ...
  <div class="container">
    <div class="page-header">
      <h2>Query Capability &quot;QueryCapabilityWaypoints&quot; results</h2>
...
End of user code
        --%>
        <% for (Waypoint aResource : resources) { %>
      <%--
