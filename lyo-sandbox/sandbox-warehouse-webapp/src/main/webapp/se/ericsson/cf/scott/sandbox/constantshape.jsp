...
<%@page import="eu.scott.coala.pddl.ConstantShape"%>
<%--
...
<%
  ConstantShape aConstantShape = (ConstantShape) request.getAttribute("aConstantShape");
%>
<%--
...
<head>
  ...
  <title><%= aConstantShape.toString(true) %></title>
...
<div class="container">
    <div class="page-header">
        <h1>ConstantShape resource</h1>
        <p class="lead">URI:&nbsp;
      <a href="<%= aConstantShape.getAbout() %>"><%= aConstantShape.getAbout() %></a>
        </p>
    </div>
        <%--
...
End of user code
        ...
        <div>
          <dl class="row">
            ...
            <dd class="col-sm-9"><%= aConstantShape.labelToHtml()%></dd>
          </dl>
        </div>
      </div>
    </div>
