...
<%@page import="eu.scott.coala.pddl.PlanShape"%>
<%--
...
<%
  PlanShape aPlanShape = (PlanShape) request.getAttribute("aPlanShape");
%>
<%--
...
<head>
  ...
  <title><%= aPlanShape.toString(true) %></title>
...
<div class="container">
    <div class="page-header">
        <h1>PlanShape resource</h1>
        <p class="lead">URI:&nbsp;
      <a href="<%= aPlanShape.getAbout() %>"><%= aPlanShape.getAbout() %></a>
        </p>
    </div>
        <%--
...
End of user code
        ...
        <div>
          <dl class="row">
            ...
            <dd class="col-sm-9"><%= aPlanShape.costToHtml()%></dd>
          </dl>
          <dl class="row">
            <dt  class="col-sm-2 text-right">step</dt>
            <dd class="col-sm-9"><%= aPlanShape.stepToHtml()%></dd>
          </dl>
          <dl class="row">
            <dt  class="col-sm-2 text-right">time</dt>
            <dd class="col-sm-9"><%= aPlanShape.timeToHtml()%></dd>
          </dl>
        </div>
      </div>
    </div>
