...
<%@page import="se.ericsson.cf.scott.sandbox.resources.VariableInstance"%>
<%--
...
<%
  VariableInstance aVariableInstance = (VariableInstance) request.getAttribute("aVariableInstance");
%>
<%--
...
<head>
  ...
  <title><%= aVariableInstance.toString(true) %></title>
...
<div class="container">
    <div class="page-header">
        <h1>VariableInstance resource</h1>
        <p class="lead">URI:&nbsp;
      <a href="<%= aVariableInstance.getAbout() %>"><%= aVariableInstance.getAbout() %></a>
        </p>
    </div>
        <%--
...
End of user code
        ...
        <div>
          <dl class="row">
            ...
            <dd class="col-sm-9"><%= aVariableInstance.valueToHtml()%></dd>
          </dl>
          <dl class="row">
            <dt  class="col-sm-2 text-right"></dt>
            <dd class="col-sm-9"><%= aVariableInstance.ToHtml()%></dd>
          </dl>
          <dl class="row">
            <dt  class="col-sm-2 text-right">order</dt>
            <dd class="col-sm-9"><%= aVariableInstance.orderToHtml()%></dd>
          </dl>
          <dl class="row">
            <dt  class="col-sm-2 text-right">instanceOf</dt>
            <dd class="col-sm-9"><%= aVariableInstance.ppInstanceOfToHtml()%></dd>
          </dl>
        </div>
      </div>
    </div>
