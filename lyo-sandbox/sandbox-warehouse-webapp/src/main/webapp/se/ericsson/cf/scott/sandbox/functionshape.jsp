...
<%@page import="eu.scott.coala.pddl.FunctionShape"%>
<%--
...
<%
  FunctionShape aFunctionShape = (FunctionShape) request.getAttribute("aFunctionShape");
%>
<%--
...
<head>
  ...
  <title><%= aFunctionShape.toString(true) %></title>
...
<div class="container">
    <div class="page-header">
        <h1>FunctionShape resource</h1>
        <p class="lead">URI:&nbsp;
      <a href="<%= aFunctionShape.getAbout() %>"><%= aFunctionShape.getAbout() %></a>
        </p>
    </div>
        <%--
...
End of user code
        ...
        <div>
          <dl class="row">
            ...
            <dd class="col-sm-9"><%= aFunctionShape.parameterToHtml()%></dd>
          </dl>
          <dl class="row">
            <dt  class="col-sm-2 text-right">label</dt>
            <dd class="col-sm-9"><%= aFunctionShape.labelToHtml()%></dd>
          </dl>
        </div>
      </div>
    </div>
