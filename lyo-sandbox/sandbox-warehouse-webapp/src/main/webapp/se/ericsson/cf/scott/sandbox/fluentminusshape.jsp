...
<%@page import="eu.scott.coala.pddl.FluentMinusShape"%>
<%--
...
<%
  FluentMinusShape aFluentMinusShape = (FluentMinusShape) request.getAttribute("aFluentMinusShape");
%>
<%--
...
<head>
  ...
  <title><%= aFluentMinusShape.toString(true) %></title>
...
<div class="container">
    <div class="page-header">
        <h1>FluentMinusShape resource</h1>
        <p class="lead">URI:&nbsp;
      <a href="<%= aFluentMinusShape.getAbout() %>"><%= aFluentMinusShape.getAbout() %></a>
        </p>
    </div>
        <%--
...
End of user code
        ...
        <div>
          <dl class="row">
            ...
            <dd class="col-sm-9"><%= aFluentMinusShape.argumentToHtml()%></dd>
          </dl>
        </div>
      </div>
    </div>
