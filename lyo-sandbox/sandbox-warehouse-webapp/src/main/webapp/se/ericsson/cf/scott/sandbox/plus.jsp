...
<%@page import="se.ericsson.cf.scott.sandbox.resources.Plus"%>
<%--
...
<%
  Plus aPlus = (Plus) request.getAttribute("aPlus");
%>
<%--
...
<head>
  ...
  <title><%= aPlus.toString(true) %></title>
...
<div class="container">
    <div class="page-header">
        <h1>Plus resource</h1>
        <p class="lead">URI:&nbsp;
      <a href="<%= aPlus.getAbout() %>"><%= aPlus.getAbout() %></a>
        </p>
    </div>
        <%--
...
End of user code
        ...
        <div>
          <dl class="row">
            ...
            <dd class="col-sm-9"><%= aPlus.rightPredicateToHtml()%></dd>
          </dl>
          <dl class="row">
            <dt  class="col-sm-2 text-right">leftPredicate</dt>
            <dd class="col-sm-9"><%= aPlus.leftPredicateToHtml()%></dd>
          </dl>
        </div>
      </div>
    </div>
