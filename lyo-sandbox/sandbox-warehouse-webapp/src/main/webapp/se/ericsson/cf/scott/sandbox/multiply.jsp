...
<%@page import="se.ericsson.cf.scott.sandbox.resources.Multiply"%>
<%--
...
<%
  Multiply aMultiply = (Multiply) request.getAttribute("aMultiply");
%>
<%--
...
<head>
  ...
  <title><%= aMultiply.toString(true) %></title>
...
<div class="container">
    <div class="page-header">
        <h1>Multiply resource</h1>
        <p class="lead">URI:&nbsp;
      <a href="<%= aMultiply.getAbout() %>"><%= aMultiply.getAbout() %></a>
        </p>
    </div>
        <%--
...
End of user code
        ...
        <div>
          <dl class="row">
            ...
            <dd class="col-sm-9"><%= aMultiply.rightPredicateToHtml()%></dd>
          </dl>
          <dl class="row">
            <dt  class="col-sm-2 text-right">leftPredicate</dt>
            <dd class="col-sm-9"><%= aMultiply.leftPredicateToHtml()%></dd>
          </dl>
        </div>
      </div>
    </div>
