...
<head>
  ...
  <title><%= aProblemState.toString(false) %></title>
...
<div>
        <div>
          <dl class="dl-horizontal">
            <dt>robots</dt>
            <dd><%= aProblemState.robotsToHtml()%></dd>
          </dl>
          <dl class="dl-horizontal">
            <dt>places</dt>
            <dd><%= aProblemState.placesToHtml()%></dd>
          </dl>
          <dl class="dl-horizontal">
            <dt>objects</dt>
            <dd><%= aProblemState.objectsToHtml()%></dd>
          </dl>
          <dl class="dl-horizontal">
            <dt>waypoints</dt>
            <dd><%= aProblemState.waypointsToHtml()%></dd>
          </dl>
        </div>
      </div>
</body>
