...
<%@page import="eu.scott.coala.pddl.EitherTypeShape"%>
<%--
...
<%
  EitherTypeShape aEitherTypeShape = (EitherTypeShape) request.getAttribute("aEitherTypeShape");
%>
<%--
...
<head>
  ...
  <title><%= aEitherTypeShape.toString(true) %></title>
...
<div class="container">
    <div class="page-header">
        <h1>EitherTypeShape resource</h1>
        <p class="lead">URI:&nbsp;
      <a href="<%= aEitherTypeShape.getAbout() %>"><%= aEitherTypeShape.getAbout() %></a>
        </p>
    </div>
        <%--
...
End of user code
        ...
        <div>
          <dl class="row">
            <dt  class="col-sm-2 text-right">member</dt>
            <dd class="col-sm-9"><%= aEitherTypeShape.memberToHtml()%></dd>
          </dl>
        </div>
      </div>
    </div>
