...
<%@page import="se.ericsson.cf.scott.sandbox.resources.PredicateArgument"%>
<%--
...
<%
  PredicateArgument aPredicateArgument = (PredicateArgument) request.getAttribute("aPredicateArgument");
%>
<%--
...
<head>
  ...
  <title><%= aPredicateArgument.toString(true) %></title>
...
<div class="container">
    <div class="page-header">
        <h1>PredicateArgument resource</h1>
        <p class="lead">URI:&nbsp;
      <a href="<%= aPredicateArgument.getAbout() %>"><%= aPredicateArgument.getAbout() %></a>
        </p>
    </div>
        <%--
...
End of user code
        ...
        <div>
          <dl class="row">
            ...
            <dd class="col-sm-9"><%= aPredicateArgument.predicateToHtml()%></dd>
          </dl>
          <dl class="row">
            <dt  class="col-sm-2 text-right">order</dt>
            <dd class="col-sm-9"><%= aPredicateArgument.orderToHtml()%></dd>
          </dl>
        </div>
      </div>
    </div>
