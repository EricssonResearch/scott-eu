...
<head>
  ...
  <title><%= aDomainShape.toString(false) %></title>
...
<div>
        <div>
          <dl class="dl-horizontal">
            <dt>action</dt>
            <dd><%= aDomainShape.actionToHtml()%></dd>
          </dl>
          <dl class="dl-horizontal">
            <dt>constant</dt>
            <dd><%= aDomainShape.constantToHtml()%></dd>
          </dl>
          <dl class="dl-horizontal">
            <dt>function</dt>
            <dd><%= aDomainShape.functionToHtml()%></dd>
          </dl>
          <dl class="dl-horizontal">
            <dt>predicate</dt>
            <dd><%= aDomainShape.predicateToHtml()%></dd>
          </dl>
          <dl class="dl-horizontal">
            <dt>type</dt>
            <dd><%= aDomainShape.typeToHtml()%></dd>
          </dl>
          <dl class="dl-horizontal">
            <dt>label</dt>
            <dd><%= aDomainShape.labelToHtml()%></dd>
          </dl>
        </div>
      </div>
</body>
