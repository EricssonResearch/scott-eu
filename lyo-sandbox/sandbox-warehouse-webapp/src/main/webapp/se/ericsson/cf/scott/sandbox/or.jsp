...
<%@page import="se.ericsson.cf.scott.sandbox.resources.Or"%>
<%--
...
<%
  Or aOr = (Or) request.getAttribute("aOr");
%>
<%--
...
<div class="container">
    <div class="page-header">
        <h1>Or resource</h1>
        <p class="lead">URI:&nbsp;
      <a href="<%= aOr.getAbout() %>"><%= aOr.getAbout() %></a>
        </p>
    </div>
        <%--
...
End of user code
        ...
        <div>
          <dl class="row">
            ...
            <dd class="col-sm-9"><%= aOr.leftPredicateToHtml()%></dd>
          </dl>
          <dl class="row">
            <dt  class="col-sm-2 text-right">rightPredicate</dt>
            <dd class="col-sm-9"><%= aOr.rightPredicateToHtml()%></dd>
          </dl>
        </div>
      </div>
    </div>
