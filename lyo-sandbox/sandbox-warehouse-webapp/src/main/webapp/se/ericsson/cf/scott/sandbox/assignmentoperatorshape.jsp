...
<%@page import="eu.scott.coala.pddl.AssignmentOperatorShape"%>
<%--
...
<%
  AssignmentOperatorShape aAssignmentOperatorShape = (AssignmentOperatorShape) request.getAttribute("aAssignmentOperatorShape");
%>
<%--
...
<head>
  ...
  <title><%= aAssignmentOperatorShape.toString(true) %></title>
...
<div class="container">
    <div class="page-header">
        <h1>AssignmentOperatorShape resource</h1>
        <p class="lead">URI:&nbsp;
      <a href="<%= aAssignmentOperatorShape.getAbout() %>"><%= aAssignmentOperatorShape.getAbout() %></a>
        </p>
    </div>
        <%--
...
End of user code
        ...
        <div>
          <dl class="row">
            ...
            <dd class="col-sm-9"><%= aAssignmentOperatorShape.argumentToHtml()%></dd>
          </dl>
          <dl class="row">
            <dt  class="col-sm-2 text-right">parameter</dt>
            <dd class="col-sm-9"><%= aAssignmentOperatorShape.parameterToHtml()%></dd>
          </dl>
        </div>
      </div>
    </div>
