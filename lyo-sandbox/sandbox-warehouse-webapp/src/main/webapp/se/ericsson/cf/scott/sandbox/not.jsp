...
<%@page import="se.ericsson.cf.scott.sandbox.resources.Not"%>
<%--
...
<%
  Not aNot = (Not) request.getAttribute("aNot");
%>
<%--
...
<head>
  ...
  <title><%= aNot.toString(true) %></title>
...
<div class="container">
    <div class="page-header">
        <h1>Not resource</h1>
        <p class="lead">URI:&nbsp;
      <a href="<%= aNot.getAbout() %>"><%= aNot.getAbout() %></a>
        </p>
    </div>
        <%--
...
End of user code
        ...
        <div>
          <dl class="row">
            ...
            <dd class="col-sm-9"><%= aNot.leftPredicateToHtml()%></dd>
          </dl>
          <dl class="row">
            <dt  class="col-sm-2 text-right">rightPredicate</dt>
            <dd class="col-sm-9"><%= aNot.rightPredicateToHtml()%></dd>
          </dl>
        </div>
      </div>
    </div>
