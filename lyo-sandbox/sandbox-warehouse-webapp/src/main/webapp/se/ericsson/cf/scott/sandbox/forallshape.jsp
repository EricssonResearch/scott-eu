...
<%@page import="eu.scott.coala.pddl.ForAllShape"%>
<%--
...
<%
  ForAllShape aForAllShape = (ForAllShape) request.getAttribute("aForAllShape");
%>
<%--
...
<head>
  ...
  <title><%= aForAllShape.toString(true) %></title>
...
<div class="container">
    <div class="page-header">
        <h1>ForAllShape resource</h1>
        <p class="lead">URI:&nbsp;
      <a href="<%= aForAllShape.getAbout() %>"><%= aForAllShape.getAbout() %></a>
        </p>
    </div>
        <%--
...
End of user code
        ...
        <div>
          <dl class="row">
            ...
            <dd class="col-sm-9"><%= aForAllShape.argumentToHtml()%></dd>
          </dl>
          <dl class="row">
            <dt  class="col-sm-2 text-right">parameter</dt>
            <dd class="col-sm-9"><%= aForAllShape.parameterToHtml()%></dd>
          </dl>
        </div>
      </div>
    </div>
