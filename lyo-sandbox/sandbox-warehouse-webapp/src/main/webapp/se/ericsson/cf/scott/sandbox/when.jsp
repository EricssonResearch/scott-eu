...
<%@page import="se.ericsson.cf.scott.sandbox.resources.When"%>
<%--
...
<%
  When aWhen = (When) request.getAttribute("aWhen");
%>
<%--
...
<head>
  ...
  <title><%= aWhen.toString(true) %></title>
...
<div class="container">
    <div class="page-header">
        <h1>When resource</h1>
        <p class="lead">URI:&nbsp;
      <a href="<%= aWhen.getAbout() %>"><%= aWhen.getAbout() %></a>
        </p>
    </div>
        <%--
