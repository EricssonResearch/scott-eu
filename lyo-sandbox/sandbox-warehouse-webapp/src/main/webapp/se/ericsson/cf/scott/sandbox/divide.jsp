...
<%@page import="se.ericsson.cf.scott.sandbox.resources.Divide"%>
<%--
...
<%
  Divide aDivide = (Divide) request.getAttribute("aDivide");
%>
<%--
...
<head>
  ...
  <title><%= aDivide.toString(true) %></title>
...
<div class="container">
    <div class="page-header">
        <h1>Divide resource</h1>
        <p class="lead">URI:&nbsp;
      <a href="<%= aDivide.getAbout() %>"><%= aDivide.getAbout() %></a>
        </p>
    </div>
        <%--
...
End of user code
        ...
        <div>
          <dl class="row">
            ...
            <dd class="col-sm-9"><%= aDivide.rightPredicateToHtml()%></dd>
          </dl>
          <dl class="row">
            <dt  class="col-sm-2 text-right">leftPredicate</dt>
            <dd class="col-sm-9"><%= aDivide.leftPredicateToHtml()%></dd>
          </dl>
        </div>
      </div>
    </div>
