...
<%@page import="se.ericsson.cf.scott.sandbox.resources.ForAll"%>
<%--
...
<%
  ForAll aForAll = (ForAll) request.getAttribute("aForAll");
%>
<%--
...
<head>
  ...
  <title><%= aForAll.toString(true) %></title>
...
<div class="container">
    <div class="page-header">
        <h1>ForAll resource</h1>
        <p class="lead">URI:&nbsp;
      <a href="<%= aForAll.getAbout() %>"><%= aForAll.getAbout() %></a>
        </p>
    </div>
        <%--
...
End of user code
        ...
        <div>
          <dl class="row">
            ...
            <dd class="col-sm-9"><%= aForAll.argumentToHtml()%></dd>
          </dl>
        </div>
      </div>
    </div>
