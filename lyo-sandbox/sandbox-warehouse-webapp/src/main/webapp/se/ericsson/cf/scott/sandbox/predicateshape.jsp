...
<%@page import="eu.scott.coala.pddl.PredicateShape"%>
<%--
...
<%
  PredicateShape aPredicateShape = (PredicateShape) request.getAttribute("aPredicateShape");
%>
<%--
...
<head>
  ...
  <title><%= aPredicateShape.toString(true) %></title>
...
<div class="container">
    <div class="page-header">
        <h1>PredicateShape resource</h1>
        <p class="lead">URI:&nbsp;
      <a href="<%= aPredicateShape.getAbout() %>"><%= aPredicateShape.getAbout() %></a>
        </p>
    </div>
        <%--
...
End of user code
        ...
        <div>
          <dl class="row">
            ...
            <dd class="col-sm-9"><%= aPredicateShape.parameterToHtml()%></dd>
          </dl>
          <dl class="row">
            <dt  class="col-sm-2 text-right">label</dt>
            <dd class="col-sm-9"><%= aPredicateShape.labelToHtml()%></dd>
          </dl>
        </div>
      </div>
    </div>
