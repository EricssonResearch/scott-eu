...
<head>
  ...
  <title><%= aActionShape.toString(false) %></title>
...
<div>
        <div>
          <dl class="dl-horizontal">
            <dt>effect</dt>
            <dd><%= aActionShape.effectToHtml()%></dd>
          </dl>
          <dl class="dl-horizontal">
            <dt>parameter</dt>
            <dd><%= aActionShape.parameterToHtml()%></dd>
          </dl>
          <dl class="dl-horizontal">
            <dt>precondition</dt>
            <dd><%= aActionShape.preconditionToHtml()%></dd>
          </dl>
          <dl class="dl-horizontal">
            <dt>label</dt>
            <dd><%= aActionShape.labelToHtml()%></dd>
          </dl>
        </div>
      </div>
</body>
