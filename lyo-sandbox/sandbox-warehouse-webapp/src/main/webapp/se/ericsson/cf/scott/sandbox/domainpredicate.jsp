...
<head>
  ...
  <title><%= aDomainPredicate.toString(true) %></title>
...
<div class="container">
    <div class="page-header">
        <h1>DomainPredicate resource</h1>
        <p class="lead">URI:&nbsp;
      <a href="<%= aDomainPredicate.getAbout() %>"><%= aDomainPredicate.getAbout() %></a>
        </p>
    </div>
        <%--
...
End of user code
        ...
        <div>
          <dl class="row">
            ...
            <dd class="col-sm-9"><%= aDomainPredicate.argumentToHtml()%></dd>
          </dl>
          <dl class="row">
            <dt  class="col-sm-2 text-right"></dt>
            <dd class="col-sm-9"><%= aDomainPredicate.ToHtml()%></dd>
          </dl>
        </div>
      </div>
    </div>
