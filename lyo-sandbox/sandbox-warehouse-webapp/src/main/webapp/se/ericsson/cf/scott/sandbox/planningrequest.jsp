...
<%@page import="se.ericsson.cf.scott.sandbox.resources.PlanningRequest"%>
<%--
...
<%
  PlanningRequest aPlanningRequest = (PlanningRequest) request.getAttribute("aPlanningRequest");
%>
<%--
...
<head>
  ...
  <title><%= aPlanningRequest.toString(true) %></title>
...
<div class="container">
    <div class="page-header">
        ...
        <h5>URI:&nbsp;
      <a href="<%= aPlanningRequest.getAbout() %>"><%= aPlanningRequest.getAbout() %></a>
        </h5>
    </div>
        <%--
...
End of user code
        ...
        <p>Summary: <%= aPlanningRequest.toHtml() %></p>

        <h2>Properties</h2>
        <table style="clear: both;">
          <tr>
            <td><%= aPlanningRequest.planningDeadlineToHtml()%></td>
          </tr>
          <tr>
            <td><%= aPlanningRequest.ToHtml()%></td>
          </tr>
          <tr>
            <td><%= aPlanningRequest.missionDeadlineToHtml()%></td>
          </tr>
          <tr>
            <td><%= aPlanningRequest.goalPredicateToHtml()%></td>
          </tr>
          <tr>
            <td><%= aPlanningRequest.initialStateToHtml()%></td>
          </tr>
        </table>
      </div>
    </div>
