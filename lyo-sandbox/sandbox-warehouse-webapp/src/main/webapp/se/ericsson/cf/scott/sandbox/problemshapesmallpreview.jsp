...
<head>
  ...
  <title><%= aProblemShape.toString(false) %></title>
...
<div>
        <div>
          <dl class="dl-horizontal">
            <dt>domain</dt>
            <dd><%= aProblemShape.domainToHtml()%></dd>
          </dl>
          <dl class="dl-horizontal">
            <dt>goal</dt>
            <dd><%= aProblemShape.goalToHtml()%></dd>
          </dl>
          <dl class="dl-horizontal">
            <dt>init</dt>
            <dd><%= aProblemShape.initToHtml()%></dd>
          </dl>
          <dl class="dl-horizontal">
            <dt>maximize</dt>
            <dd><%= aProblemShape.maximizeToHtml()%></dd>
          </dl>
          <dl class="dl-horizontal">
            <dt>minimize</dt>
            <dd><%= aProblemShape.minimizeToHtml()%></dd>
          </dl>
          <dl class="dl-horizontal">
            <dt>object</dt>
            <dd><%= aProblemShape.pddlObjectToHtml()%></dd>
          </dl>
          <dl class="dl-horizontal">
            <dt>label</dt>
            <dd><%= aProblemShape.labelToHtml()%></dd>
          </dl>
        </div>
      </div>
</body>
