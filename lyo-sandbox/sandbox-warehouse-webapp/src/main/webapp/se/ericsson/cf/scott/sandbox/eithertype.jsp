...
<%@page import="eu.scott.coala.pddl.EitherType"%>
<%--
...
<%
  EitherType aEitherType = (EitherType) request.getAttribute("aEitherType");
%>
<%--
...
<head>
  ...
  <title><%= aEitherType.toString(true) %></title>
...
<div class="container">
    <div class="page-header">
        <h1>EitherType resource</h1>
        <p class="lead">URI:&nbsp;
      <a href="<%= aEitherType.getAbout() %>"><%= aEitherType.getAbout() %></a>
        </p>
    </div>
        <%--
