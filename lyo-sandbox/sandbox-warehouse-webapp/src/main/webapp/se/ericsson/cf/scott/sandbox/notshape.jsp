...
<%@page import="eu.scott.coala.pddl.NotShape"%>
<%--
...
<%
  NotShape aNotShape = (NotShape) request.getAttribute("aNotShape");
%>
<%--
...
<head>
  ...
  <title><%= aNotShape.toString(true) %></title>
...
<div class="container">
    <div class="page-header">
        <h1>NotShape resource</h1>
        <p class="lead">URI:&nbsp;
      <a href="<%= aNotShape.getAbout() %>"><%= aNotShape.getAbout() %></a>
        </p>
    </div>
        <%--
...
End of user code
        ...
        <div>
          <dl class="row">
            ...
            <dd class="col-sm-9"><%= aNotShape.argumentToHtml()%></dd>
          </dl>
        </div>
      </div>
    </div>
