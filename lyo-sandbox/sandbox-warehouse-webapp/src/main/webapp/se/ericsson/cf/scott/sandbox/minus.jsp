...
<head>
  ...
  <title><%= aMinus.toString(true) %></title>
...
<div class="container">
    <div class="page-header">
        <h1>Minus resource</h1>
        <p class="lead">URI:&nbsp;
      <a href="<%= aMinus.getAbout() %>"><%= aMinus.getAbout() %></a>
        </p>
    </div>
        <%--
...
End of user code
        ...
        <div>
          <dl class="row">
            ...
            <dd class="col-sm-9"><%= aMinus.leftPredicateToHtml()%></dd>
          </dl>
          <dl class="row">
            <dt  class="col-sm-2 text-right">rightPredicate</dt>
            <dd class="col-sm-9"><%= aMinus.rightPredicateToHtml()%></dd>
          </dl>
        </div>
      </div>
    </div>
