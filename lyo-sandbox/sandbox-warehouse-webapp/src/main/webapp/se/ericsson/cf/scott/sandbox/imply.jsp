...
<%@page import="se.ericsson.cf.scott.sandbox.resources.Imply"%>
<%--
...
<%
  Imply aImply = (Imply) request.getAttribute("aImply");
%>
<%--
...
<head>
  ...
  <title><%= aImply.toString(true) %></title>
...
<div class="container">
    <div class="page-header">
        <h1>Imply resource</h1>
        <p class="lead">URI:&nbsp;
      <a href="<%= aImply.getAbout() %>"><%= aImply.getAbout() %></a>
        </p>
    </div>
        <%--
