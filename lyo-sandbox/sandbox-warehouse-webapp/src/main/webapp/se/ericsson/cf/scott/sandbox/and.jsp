...
<%@page import="se.ericsson.cf.scott.sandbox.resources.And"%>
<%--
...
<%
  And aAnd = (And) request.getAttribute("aAnd");
%>
<%--
...
<head>
  ...
  <title><%= aAnd.toString(true) %></title>
...
<div class="container">
    <div class="page-header">
        <h1>And resource</h1>
        <p class="lead">URI:&nbsp;
      <a href="<%= aAnd.getAbout() %>"><%= aAnd.getAbout() %></a>
        </p>
    </div>
        <%--
...
End of user code
        ...
        <div>
          <dl class="row">
            ...
            <dd class="col-sm-9"><%= aAnd.leftPredicateToHtml()%></dd>
          </dl>
          <dl class="row">
            <dt  class="col-sm-2 text-right">rightPredicate</dt>
            <dd class="col-sm-9"><%= aAnd.rightPredicateToHtml()%></dd>
          </dl>
        </div>
      </div>
    </div>
