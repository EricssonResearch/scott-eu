...
<%@page import="se.ericsson.cf.scott.sandbox.resources.Mission"%>
<%--
...
<%
  Mission aMission = (Mission) request.getAttribute("aMission");
%>
<%--
...
<head>
  ...
  <title><%= aMission.toString(true) %></title>
...
<div class="container">
    <div class="page-header">
        ...
        <h5>URI:&nbsp;
      <a href="<%= aMission.getAbout() %>"><%= aMission.getAbout() %></a>
        </h5>
    </div>
        <%--
...
End of user code
        ...
        <table style="clear: both;">
          ...
          <tr>
            <td><%= aMission.labelToHtml()%></td>
          </tr>
          <tr>
            <td><%= aMission.missionDeadlineToHtml()%></td>
          </tr>
          <tr>
            <td><%= aMission.goalPredicateToHtml()%></td>
          </tr>
          <tr>
            <td><%= aMission.initialStateToHtml()%></td>
          </tr>
        </table>
      </div>
    </div>
