...
<head>
  ...
  <title><%= aStepShape.toString(false) %></title>
...
<div>
        <div>
          <dl class="dl-horizontal">
            <dt>action</dt>
            <dd><%= aStepShape.actionToHtml()%></dd>
          </dl>
          <dl class="dl-horizontal">
            <dt>adding</dt>
            <dd><%= aStepShape.addingToHtml()%></dd>
          </dl>
          <dl class="dl-horizontal">
            <dt>deleting</dt>
            <dd><%= aStepShape.deletingToHtml()%></dd>
          </dl>
          <dl class="dl-horizontal">
            <dt>updating</dt>
            <dd><%= aStepShape.updatingToHtml()%></dd>
          </dl>
          <dl class="dl-horizontal">
            <dt>order</dt>
            <dd><%= aStepShape.orderToHtml()%></dd>
          </dl>
        </div>
      </div>
</body>
