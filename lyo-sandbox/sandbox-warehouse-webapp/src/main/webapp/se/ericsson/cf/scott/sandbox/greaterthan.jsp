...
<%@page import="se.ericsson.cf.scott.sandbox.resources.GreaterThan"%>
<%--
...
<%
  GreaterThan aGreaterThan = (GreaterThan) request.getAttribute("aGreaterThan");
%>
<%--
...
<head>
  ...
  <title><%= aGreaterThan.toString(true) %></title>
...
<div class="container">
    <div class="page-header">
        <h1>GreaterThan resource</h1>
        <p class="lead">URI:&nbsp;
      <a href="<%= aGreaterThan.getAbout() %>"><%= aGreaterThan.getAbout() %></a>
        </p>
    </div>
        <%--
...
End of user code
        ...
        <div>
          <dl class="row">
            ...
            <dd class="col-sm-9"><%= aGreaterThan.leftPredicateToHtml()%></dd>
          </dl>
          <dl class="row">
            <dt  class="col-sm-2 text-right">rightPredicate</dt>
            <dd class="col-sm-9"><%= aGreaterThan.rightPredicateToHtml()%></dd>
          </dl>
        </div>
      </div>
    </div>
