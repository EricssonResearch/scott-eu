...
<head>
  ...
  <title><%= aVariableInstance.toString(false) %></title>
...
<div>
        <div>
          <dl class="dl-horizontal">
            <dt>value</dt>
            <dd><%= aVariableInstance.valueToHtml()%></dd>
          </dl>
          <dl class="dl-horizontal">
            <dt></dt>
            <dd><%= aVariableInstance.ToHtml()%></dd>
          </dl>
          <dl class="dl-horizontal">
            <dt>order</dt>
            <dd><%= aVariableInstance.orderToHtml()%></dd>
          </dl>
          <dl class="dl-horizontal">
            <dt>instanceOf</dt>
            <dd><%= aVariableInstance.ppInstanceOfToHtml()%></dd>
          </dl>
        </div>
      </div>
</body>
