...
<%@page import="eu.scott.coala.pddl.WhenShape"%>
<%--
...
<%
  WhenShape aWhenShape = (WhenShape) request.getAttribute("aWhenShape");
%>
<%--
...
<head>
  ...
  <title><%= aWhenShape.toString(true) %></title>
...
<div class="container">
    <div class="page-header">
        <h1>WhenShape resource</h1>
        <p class="lead">URI:&nbsp;
      <a href="<%= aWhenShape.getAbout() %>"><%= aWhenShape.getAbout() %></a>
        </p>
    </div>
        <%--
...
End of user code
        ...
        <div>
          <dl class="row">
            ...
            <dd class="col-sm-9"><%= aWhenShape.argumentToHtml()%></dd>
          </dl>
          <dl class="row">
            <dt  class="col-sm-2 text-right">parameter</dt>
            <dd class="col-sm-9"><%= aWhenShape.parameterToHtml()%></dd>
          </dl>
        </div>
      </div>
    </div>
