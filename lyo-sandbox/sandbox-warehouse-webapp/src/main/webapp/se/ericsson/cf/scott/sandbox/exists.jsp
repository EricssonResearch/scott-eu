...
<%@page import="se.ericsson.cf.scott.sandbox.resources.Exists"%>
<%--
...
<%
  Exists aExists = (Exists) request.getAttribute("aExists");
%>
<%--
...
<head>
  ...
  <title><%= aExists.toString(true) %></title>
...
<div class="container">
    <div class="page-header">
        <h1>Exists resource</h1>
        <p class="lead">URI:&nbsp;
      <a href="<%= aExists.getAbout() %>"><%= aExists.getAbout() %></a>
        </p>
    </div>
        <%--
