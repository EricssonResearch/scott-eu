...
<%@page import="eu.scott.coala.pddl.StepShape"%>
<%--
...
<%
  StepShape aStepShape = (StepShape) request.getAttribute("aStepShape");
%>
<%--
...
<head>
  ...
  <title><%= aStepShape.toString(true) %></title>
...
<div class="container">
    <div class="page-header">
        <h1>StepShape resource</h1>
        <p class="lead">URI:&nbsp;
      <a href="<%= aStepShape.getAbout() %>"><%= aStepShape.getAbout() %></a>
        </p>
    </div>
        <%--
...
End of user code
        ...
        <div>
          <dl class="row">
            ...
            <dd class="col-sm-9"><%= aStepShape.actionToHtml()%></dd>
          </dl>
          <dl class="row">
            <dt  class="col-sm-2 text-right">adding</dt>
            <dd class="col-sm-9"><%= aStepShape.addingToHtml()%></dd>
          </dl>
          <dl class="row">
            <dt  class="col-sm-2 text-right">deleting</dt>
            <dd class="col-sm-9"><%= aStepShape.deletingToHtml()%></dd>
          </dl>
          <dl class="row">
            <dt  class="col-sm-2 text-right">updating</dt>
            <dd class="col-sm-9"><%= aStepShape.updatingToHtml()%></dd>
          </dl>
          <dl class="row">
            <dt  class="col-sm-2 text-right">order</dt>
            <dd class="col-sm-9"><%= aStepShape.orderToHtml()%></dd>
          </dl>
        </div>
      </div>
    </div>
