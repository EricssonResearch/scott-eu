...
<%@page import="se.ericsson.cf.scott.sandbox.resources.ProblemState"%>
<%--
...
<%
  ProblemState aProblemState = (ProblemState) request.getAttribute("aProblemState");
%>
<%--
...
<head>
  ...
  <title><%= aProblemState.toString(true) %></title>
...
<div class="container">
    <div class="page-header">
        <h1>ProblemState resource</h1>
        <p class="lead">URI:&nbsp;
      <a href="<%= aProblemState.getAbout() %>"><%= aProblemState.getAbout() %></a>
        </p>
    </div>
        <%--
...
End of user code
        ...
        <div>
          <dl class="row">
            <dt  class="col-sm-2 text-right">robots</dt>
            <dd class="col-sm-9"><%= aProblemState.robotsToHtml()%></dd>
          </dl>
          <dl class="row">
            <dt  class="col-sm-2 text-right">places</dt>
            <dd class="col-sm-9"><%= aProblemState.placesToHtml()%></dd>
          </dl>
          <dl class="row">
            <dt  class="col-sm-2 text-right">objects</dt>
            <dd class="col-sm-9"><%= aProblemState.objectsToHtml()%></dd>
          </dl>
          <dl class="row">
            <dt  class="col-sm-2 text-right">waypoints</dt>
            <dd class="col-sm-9"><%= aProblemState.waypointsToHtml()%></dd>
          </dl>
        </div>
      </div>
    </div>
