...
<%@page import="se.ericsson.cf.scott.sandbox.resources.ProblemFile"%>
<%--
...
<%
  ProblemFile aProblemFile = (ProblemFile) request.getAttribute("aProblemFile");
%>
<%--
...
<head>
  ...
  <title><%= aProblemFile.toString(true) %></title>
...
<div class="container">
    <div class="page-header">
        <h1>ProblemFile resource</h1>
        <p class="lead">URI:&nbsp;
      <a href="<%= aProblemFile.getAbout() %>"><%= aProblemFile.getAbout() %></a>
        </p>
    </div>
        <%--
...
End of user code
        ...
        <div>
          <dl class="row">
            <dt  class="col-sm-2 text-right">body</dt>
            <dd class="col-sm-9"><%= aProblemFile.bodyToHtml()%></dd>
          </dl>
        </div>
      </div>
    </div>
