...
<%@page import="se.ericsson.cf.scott.sandbox.resources.GreaterOrEqual"%>
<%--
...
<%
  GreaterOrEqual aGreaterOrEqual = (GreaterOrEqual) request.getAttribute("aGreaterOrEqual");
%>
<%--
...
<head>
  ...
  <title><%= aGreaterOrEqual.toString(true) %></title>
...
<div class="container">
    <div class="page-header">
        <h1>GreaterOrEqual resource</h1>
        <p class="lead">URI:&nbsp;
      <a href="<%= aGreaterOrEqual.getAbout() %>"><%= aGreaterOrEqual.getAbout() %></a>
        </p>
    </div>
        <%--
...
End of user code
        ...
        <div>
          <dl class="row">
            ...
            <dd class="col-sm-9"><%= aGreaterOrEqual.leftPredicateToHtml()%></dd>
          </dl>
          <dl class="row">
            <dt  class="col-sm-2 text-right">rightPredicate</dt>
            <dd class="col-sm-9"><%= aGreaterOrEqual.rightPredicateToHtml()%></dd>
          </dl>
        </div>
      </div>
    </div>
