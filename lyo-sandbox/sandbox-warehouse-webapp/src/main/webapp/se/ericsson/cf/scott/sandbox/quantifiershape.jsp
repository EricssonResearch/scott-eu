...
<%@page import="eu.scott.coala.pddl.QuantifierShape"%>
<%--
...
<%
  QuantifierShape aQuantifierShape = (QuantifierShape) request.getAttribute("aQuantifierShape");
%>
<%--
...
<head>
  ...
  <title><%= aQuantifierShape.toString(true) %></title>
...
<div class="container">
    <div class="page-header">
        <h1>QuantifierShape resource</h1>
        <p class="lead">URI:&nbsp;
      <a href="<%= aQuantifierShape.getAbout() %>"><%= aQuantifierShape.getAbout() %></a>
        </p>
    </div>
        <%--
...
End of user code
        ...
        <div>
          <dl class="row">
            ...
            <dd class="col-sm-9"><%= aQuantifierShape.argumentToHtml()%></dd>
          </dl>
          <dl class="row">
            <dt  class="col-sm-2 text-right">parameter</dt>
            <dd class="col-sm-9"><%= aQuantifierShape.parameterToHtml()%></dd>
          </dl>
        </div>
      </div>
    </div>
