...
<%@page import="eu.scott.coala.pddl.ActionShape"%>
<%--
...
<%
  ActionShape aActionShape = (ActionShape) request.getAttribute("aActionShape");
%>
<%--
...
<head>
  ...
  <title><%= aActionShape.toString(true) %></title>
...
<div class="container">
    <div class="page-header">
        <h1>ActionShape resource</h1>
        <p class="lead">URI:&nbsp;
      <a href="<%= aActionShape.getAbout() %>"><%= aActionShape.getAbout() %></a>
        </p>
    </div>
        <%--
...
End of user code
        ...
        <div>
          <dl class="row">
            ...
            <dd class="col-sm-9"><%= aActionShape.effectToHtml()%></dd>
          </dl>
          <dl class="row">
            <dt  class="col-sm-2 text-right">parameter</dt>
            <dd class="col-sm-9"><%= aActionShape.parameterToHtml()%></dd>
          </dl>
          <dl class="row">
            <dt  class="col-sm-2 text-right">precondition</dt>
            <dd class="col-sm-9"><%= aActionShape.preconditionToHtml()%></dd>
          </dl>
          <dl class="row">
            <dt  class="col-sm-2 text-right">label</dt>
            <dd class="col-sm-9"><%= aActionShape.labelToHtml()%></dd>
          </dl>
        </div>
      </div>
    </div>
