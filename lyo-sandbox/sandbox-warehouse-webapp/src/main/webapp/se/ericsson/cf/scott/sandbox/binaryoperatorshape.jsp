...
<%@page import="eu.scott.coala.pddl.BinaryOperatorShape"%>
<%--
...
<%
  BinaryOperatorShape aBinaryOperatorShape = (BinaryOperatorShape) request.getAttribute("aBinaryOperatorShape");
%>
<%--
...
<head>
  ...
  <title><%= aBinaryOperatorShape.toString(true) %></title>
...
<div class="container">
    <div class="page-header">
        <h1>BinaryOperatorShape resource</h1>
        <p class="lead">URI:&nbsp;
      <a href="<%= aBinaryOperatorShape.getAbout() %>"><%= aBinaryOperatorShape.getAbout() %></a>
        </p>
    </div>
        <%--
...
End of user code
        ...
        <div>
          <dl class="row">
            ...
            <dd class="col-sm-9"><%= aBinaryOperatorShape.argumentToHtml()%></dd>
          </dl>
        </div>
      </div>
    </div>
