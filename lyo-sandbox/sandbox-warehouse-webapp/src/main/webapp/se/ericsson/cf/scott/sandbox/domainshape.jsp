...
<%@page import="eu.scott.coala.pddl.DomainShape"%>
<%--
...
<%
  DomainShape aDomainShape = (DomainShape) request.getAttribute("aDomainShape");
%>
<%--
...
<head>
  ...
  <title><%= aDomainShape.toString(true) %></title>
...
<div class="container">
    <div class="page-header">
        <h1>DomainShape resource</h1>
        <p class="lead">URI:&nbsp;
      <a href="<%= aDomainShape.getAbout() %>"><%= aDomainShape.getAbout() %></a>
        </p>
    </div>
        <%--
...
End of user code
        ...
        <div>
          <dl class="row">
            ...
            <dd class="col-sm-9"><%= aDomainShape.actionToHtml()%></dd>
          </dl>
          <dl class="row">
            <dt  class="col-sm-2 text-right">constant</dt>
            <dd class="col-sm-9"><%= aDomainShape.constantToHtml()%></dd>
          </dl>
          <dl class="row">
            <dt  class="col-sm-2 text-right">function</dt>
            <dd class="col-sm-9"><%= aDomainShape.functionToHtml()%></dd>
          </dl>
          <dl class="row">
            <dt  class="col-sm-2 text-right">predicate</dt>
            <dd class="col-sm-9"><%= aDomainShape.predicateToHtml()%></dd>
          </dl>
          <dl class="row">
            <dt  class="col-sm-2 text-right">type</dt>
            <dd class="col-sm-9"><%= aDomainShape.typeToHtml()%></dd>
          </dl>
          <dl class="row">
            <dt  class="col-sm-2 text-right">label</dt>
            <dd class="col-sm-9"><%= aDomainShape.labelToHtml()%></dd>
          </dl>
        </div>
      </div>
    </div>
