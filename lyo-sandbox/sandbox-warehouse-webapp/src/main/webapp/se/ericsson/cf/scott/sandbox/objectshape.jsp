...
<%@page import="eu.scott.coala.pddl.ObjectShape"%>
<%--
...
<%
  ObjectShape aObjectShape = (ObjectShape) request.getAttribute("aObjectShape");
%>
<%--
...
<head>
  ...
  <title><%= aObjectShape.toString(true) %></title>
...
<div class="container">
    <div class="page-header">
        <h1>ObjectShape resource</h1>
        <p class="lead">URI:&nbsp;
      <a href="<%= aObjectShape.getAbout() %>"><%= aObjectShape.getAbout() %></a>
        </p>
    </div>
        <%--
...
End of user code
        ...
        <div>
          <dl class="row">
            ...
            <dd class="col-sm-9"><%= aObjectShape.labelToHtml()%></dd>
          </dl>
        </div>
      </div>
    </div>
