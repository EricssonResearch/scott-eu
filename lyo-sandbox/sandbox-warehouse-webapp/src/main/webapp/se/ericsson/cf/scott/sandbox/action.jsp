...
<%@page import="se.ericsson.cf.scott.sandbox.resources.Action"%>
<%--
...
<%
  Action aAction = (Action) request.getAttribute("aAction");
%>
<%--
...
<head>
  ...
  <title><%= aAction.toString(true) %></title>
...
<div class="container">
    <div class="page-header">
        ...
        <p class="lead">URI:&nbsp;
      <a href="<%= aAction.getAbout() %>"><%= aAction.getAbout() %></a>
        </p>
    </div>
        <%--
...
End of user code
        ...
        <div>
          <dl class="row">
            <dt  class="col-sm-2 text-right">ofActionType</dt>
            <dd class="col-sm-9"><%= aAction.ofActionTypeToHtml()%></dd>
          </dl>
          <dl class="row">
            <dt  class="col-sm-2 text-right">withVariable</dt>
            <dd class="col-sm-9"><%= aAction.withVariableToHtml()%></dd>
          </dl>
          <dl class="row">
            <dt  class="col-sm-2 text-right">order</dt>
            <dd class="col-sm-9"><%= aAction.orderToHtml()%></dd>
          </dl>
        </div>
      </div>
    </div>
