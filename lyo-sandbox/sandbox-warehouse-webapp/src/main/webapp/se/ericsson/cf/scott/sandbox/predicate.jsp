...
<%@page import="se.ericsson.cf.scott.sandbox.resources.Predicate"%>
<%--
...
<%
  Predicate aPredicate = (Predicate) request.getAttribute("aPredicate");
%>
<%--
...
<head>
  ...
  <title><%= aPredicate.toString(true) %></title>
...
<div class="container">
    <div class="page-header">
        <h1>Predicate resource</h1>
        <p class="lead">URI:&nbsp;
      <a href="<%= aPredicate.getAbout() %>"><%= aPredicate.getAbout() %></a>
        </p>
    </div>
        <%--
...
End of user code
        ...
        <div>
          <dl class="row">
            ...
            <dd class="col-sm-9"><%= aPredicate.ToHtml()%></dd>
          </dl>
        </div>
      </div>
    </div>
