...
<%@page import="se.ericsson.cf.scott.sandbox.resources.ActionType"%>
<%--
...
<%
  ActionType aActionType = (ActionType) request.getAttribute("aActionType");
%>
<%--
...
<head>
  ...
  <title><%= aActionType.toString(true) %></title>
...
<div class="container">
    <div class="page-header">
        <h1>ActionType resource</h1>
        <p class="lead">URI:&nbsp;
      <a href="<%= aActionType.getAbout() %>"><%= aActionType.getAbout() %></a>
        </p>
    </div>
        <%--
...
End of user code
        ...
        <div>
          <dl class="row">
            ...
            <dd class="col-sm-9"><%= aActionType.ToHtml()%></dd>
          </dl>
          <dl class="row">
            <dt  class="col-sm-2 text-right">hasVariable</dt>
            <dd class="col-sm-9"><%= aActionType.hasVariableToHtml()%></dd>
          </dl>
          <dl class="row">
            <dt  class="col-sm-2 text-right">precondition</dt>
            <dd class="col-sm-9"><%= aActionType.preconditionToHtml()%></dd>
          </dl>
          <dl class="row">
            <dt  class="col-sm-2 text-right">effect</dt>
            <dd class="col-sm-9"><%= aActionType.effectToHtml()%></dd>
          </dl>
          <dl class="row">
            <dt  class="col-sm-2 text-right"></dt>
            <dd class="col-sm-9"><%= aActionType.ToHtml()%></dd>
