...
<%@page import="se.ericsson.cf.scott.sandbox.resources.FluentInstance"%>
<%--
...
<%
  FluentInstance aFluentInstance = (FluentInstance) request.getAttribute("aFluentInstance");
%>
<%--
...
<head>
  ...
  <title><%= aFluentInstance.toString(true) %></title>
...
<div class="container">
    <div class="page-header">
        <h1>FluentInstance resource</h1>
        <p class="lead">URI:&nbsp;
      <a href="<%= aFluentInstance.getAbout() %>"><%= aFluentInstance.getAbout() %></a>
        </p>
    </div>
        <%--
...
End of user code
        ...
        <div>
          <dl class="row">
            <dt  class="col-sm-2 text-right">fluentType</dt>
            <dd class="col-sm-9"><%= aFluentInstance.fluentTypeToHtml()%></dd>
          </dl>
          <dl class="row">
            <dt  class="col-sm-2 text-right">withVariable</dt>
            <dd class="col-sm-9"><%= aFluentInstance.withVariableToHtml()%></dd>
          </dl>
        </div>
      </div>
    </div>
