...
<%@page import="se.ericsson.cf.scott.sandbox.resources.Plan"%>
<%--
...
End of user code
        ...
        <div>
          <dl class="row">
            <dt  class="col-sm-2 text-right">forMission</dt>
            <dd class="col-sm-9"><%= aPlan.forMissionToHtml()%></dd>
          </dl>
          <dl class="row">
            <dt  class="col-sm-2 text-right">relatesToAction</dt>
            <dd class="col-sm-9"><%= aPlan.relatesToActionToHtml()%></dd>
          </dl>
        </div>
      </div>
    </div>
