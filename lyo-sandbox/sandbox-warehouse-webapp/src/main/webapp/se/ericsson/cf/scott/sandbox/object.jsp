...
<%
  Object aObject = (Object) request.getAttribute("aObject");
%>
<%--
...
<html>
  <head>
    ...
    <title><%= aObject.toString(true) %></title>
    <%--
...
End of user code
        ...
        <p>Summary: <%= aObject.toHtml() %><br /></p>
        <h2>Properties</h2>
        <table style="clear: both;">
          <tr>
            <td><%= aObject.isOnToHtml()%></td>
          </tr>
          <tr>
            <td><%= aObject.carriedByToHtml()%></td>
          </tr>
          <tr>
            <td><%= aObject.typeToHtml()%></td>
          </tr>
        </table>
      </div>
    </div>
