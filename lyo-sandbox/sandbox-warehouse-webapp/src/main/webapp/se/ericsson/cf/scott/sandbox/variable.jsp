...
<%@page import="se.ericsson.cf.scott.sandbox.resources.Variable"%>
<%--
...
<%
  Variable aVariable = (Variable) request.getAttribute("aVariable");
%>
<%--
...
<head>
  ...
  <title><%= aVariable.toString(true) %></title>
...
<div class="container">
    <div class="page-header">
        <h1>Variable resource</h1>
        <p class="lead">URI:&nbsp;
      <a href="<%= aVariable.getAbout() %>"><%= aVariable.getAbout() %></a>
        </p>
    </div>
        <%--
...
End of user code
        ...
        <div>
          <dl class="row">
            <dt  class="col-sm-2 text-right">resourceType</dt>
            <dd class="col-sm-9"><%= aVariable.resourceTypeToHtml()%></dd>
          </dl>
          <dl class="row">
            <dt  class="col-sm-2 text-right"></dt>
            <dd class="col-sm-9"><%= aVariable.ToHtml()%></dd>
          </dl>
          <dl class="row">
            <dt  class="col-sm-2 text-right">order</dt>
            <dd class="col-sm-9"><%= aVariable.orderToHtml()%></dd>
          </dl>
        </div>
      </div>
    </div>
