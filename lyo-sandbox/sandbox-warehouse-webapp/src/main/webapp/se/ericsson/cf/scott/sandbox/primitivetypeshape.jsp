...
<%@page import="eu.scott.coala.pddl.PrimitiveTypeShape"%>
<%--
...
<%
  PrimitiveTypeShape aPrimitiveTypeShape = (PrimitiveTypeShape) request.getAttribute("aPrimitiveTypeShape");
%>
<%--
...
<head>
  ...
  <title><%= aPrimitiveTypeShape.toString(true) %></title>
...
<div class="container">
    <div class="page-header">
        <h1>PrimitiveTypeShape resource</h1>
        <p class="lead">URI:&nbsp;
      <a href="<%= aPrimitiveTypeShape.getAbout() %>"><%= aPrimitiveTypeShape.getAbout() %></a>
        </p>
    </div>
        <%--
...
End of user code
        ...
        <div>
          <dl class="row">
            ...
            <dd class="col-sm-9"><%= aPrimitiveTypeShape.labelToHtml()%></dd>
          </dl>
        </div>
      </div>
    </div>
