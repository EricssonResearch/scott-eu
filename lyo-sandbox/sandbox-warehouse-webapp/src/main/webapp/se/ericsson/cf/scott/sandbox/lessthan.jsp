...
<%@page import="se.ericsson.cf.scott.sandbox.resources.LessThan"%>
<%--
...
<%
  LessThan aLessThan = (LessThan) request.getAttribute("aLessThan");
%>
<%--
...
<head>
  ...
  <title><%= aLessThan.toString(true) %></title>
...
<div class="container">
    <div class="page-header">
        <h1>LessThan resource</h1>
        <p class="lead">URI:&nbsp;
      <a href="<%= aLessThan.getAbout() %>"><%= aLessThan.getAbout() %></a>
        </p>
    </div>
        <%--
...
End of user code
        ...
        <div>
          <dl class="row">
            ...
            <dd class="col-sm-9"><%= aLessThan.leftPredicateToHtml()%></dd>
          </dl>
          <dl class="row">
            <dt  class="col-sm-2 text-right">rightPredicate</dt>
            <dd class="col-sm-9"><%= aLessThan.rightPredicateToHtml()%></dd>
          </dl>
        </div>
      </div>
    </div>
