...
<%@page import="se.ericsson.cf.scott.sandbox.resources.EqualTo"%>
<%--
...
<%
  EqualTo aEqualTo = (EqualTo) request.getAttribute("aEqualTo");
%>
<%--
...
<head>
  ...
  <title><%= aEqualTo.toString(true) %></title>
...
<div class="container">
    <div class="page-header">
        <h1>EqualTo resource</h1>
        <p class="lead">URI:&nbsp;
      <a href="<%= aEqualTo.getAbout() %>"><%= aEqualTo.getAbout() %></a>
        </p>
    </div>
        <%--
...
End of user code
        ...
        <div>
          <dl class="row">
            ...
            <dd class="col-sm-9"><%= aEqualTo.rightPredicateToHtml()%></dd>
          </dl>
          <dl class="row">
            <dt  class="col-sm-2 text-right">leftPredicate</dt>
            <dd class="col-sm-9"><%= aEqualTo.leftPredicateToHtml()%></dd>
          </dl>
        </div>
      </div>
    </div>
