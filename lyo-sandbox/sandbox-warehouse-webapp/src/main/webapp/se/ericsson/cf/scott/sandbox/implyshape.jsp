...
<%@page import="eu.scott.coala.pddl.ImplyShape"%>
<%--
...
<%
  ImplyShape aImplyShape = (ImplyShape) request.getAttribute("aImplyShape");
%>
<%--
...
<head>
  ...
  <title><%= aImplyShape.toString(true) %></title>
...
<div class="container">
    <div class="page-header">
        <h1>ImplyShape resource</h1>
        <p class="lead">URI:&nbsp;
      <a href="<%= aImplyShape.getAbout() %>"><%= aImplyShape.getAbout() %></a>
        </p>
    </div>
        <%--
...
End of user code
        ...
        <div>
          <dl class="row">
            ...
            <dd class="col-sm-9"><%= aImplyShape.argumentToHtml()%></dd>
          </dl>
        </div>
      </div>
    </div>
