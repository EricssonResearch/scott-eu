...
<%
  List<WhObject> resources = (List<WhObject>) request.getAttribute("resources");
...
<head>
  ...
  <title>Query capability QueryCapabilityObjects</title>
...
<nav class="navbar navbar-default navbar-fixed-top">
  ...
  <div class="container">
    <div class="page-header">
      <h2>Query Capability &quot;QueryCapabilityObjects&quot; results</h2>
...
End of user code
        --%>
        <% for (WhObject aResource : resources) { %>
      <%--
