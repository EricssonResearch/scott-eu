...
<%@page import="se.ericsson.cf.scott.sandbox.resources.Robot"%>
<%--
...
<%
  Robot aRobot = (Robot) request.getAttribute("aRobot");
%>
<%--
...
<head>
  ...
  <title><%= aRobot.toString(true) %></title>
...
<div class="container">
    <div class="page-header">
        ...
        <h5>URI:&nbsp;
      <a href="<%= aRobot.getAbout() %>"><%= aRobot.getAbout() %></a>
        </h5>
    </div>
        <%--
...
End of user code
        ...
        <table style="clear: both;">
          ...
          <tr>
            <td><%= aRobot.chargeLevelToHtml()%></td>
          </tr>
          <tr>
            <td><%= aRobot.isAtToHtml()%></td>
          </tr>
          <tr>
            <td><%= aRobot.isChargingToHtml()%></td>
          </tr>
          <tr>
            <td><%= aRobot.maxChargeToHtml()%></td>
          </tr>
          <tr>
            <td><%= aRobot.highChargeToHtml()%></td>
          </tr>
          <tr>
            <td><%= aRobot.lowChargeToHtml()%></td>
          </tr>
        </table>
      </div>
    </div>
