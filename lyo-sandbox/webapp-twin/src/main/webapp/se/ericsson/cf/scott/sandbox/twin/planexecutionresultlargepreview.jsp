...
<head>
  ...
  <title><%= aPlanExecutionResult.toString(false) %></title>
...
<div>
        <div>
          <dl class="dl-horizontal">
            <dt>plan</dt>
            <dd><%= aPlanExecutionResult.planToHtml()%></dd>
          </dl>
          <dl class="dl-horizontal">
            <dt>isSuccessful</dt>
            <dd><%= aPlanExecutionResult.isSuccessfulToHtml()%></dd>
          </dl>
          <dl class="dl-horizontal">
            <dt>durationSeconds</dt>
            <dd><%= aPlanExecutionResult.durationSecondsToHtml()%></dd>
          </dl>
        </div>
      </div>
</body>
