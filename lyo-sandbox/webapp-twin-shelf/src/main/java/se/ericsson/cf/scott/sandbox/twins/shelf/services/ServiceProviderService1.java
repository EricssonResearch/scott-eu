...
public class ServiceProviderService1
{
        ...
        ) throws IOException, ServletException, URISyntaxException
    {
        ...
        final PlanExecutionResult aPlanExecutionResult = ShelfTwinManager.getPlanExecutionResult(httpServletRequest, serviceProviderId, planExecutionResultId);
        ...
        ) throws ServletException, IOException, URISyntaxException
    {
        ...
        if (aPlanExecutionResult != null) {
            ...
            RequestDispatcher rd = httpServletRequest.getRequestDispatcher("/se/ericsson/cf/scott/sandbox/twins/shelf/planexecutionresult.jsp");
        ...
        ) throws ServletException, IOException, URISyntaxException
    {
        ...
        if (aPlanExecutionResult != null) {
            ...
            RequestDispatcher rd = httpServletRequest.getRequestDispatcher("/se/ericsson/cf/scott/sandbox/twins/shelf/planexecutionresultsmallpreview.jsp");
            httpServletResponse.addHeader(ShelfTwinConstants.HDR_OSLC_VERSION, ShelfTwinConstants.OSLC_VERSION_V2);
            rd.forward(httpServletRequest, httpServletResponse);
        }
        ...
        ) throws ServletException, IOException, URISyntaxException
    {
        ...
        if (aPlanExecutionResult != null) {
            ...
            RequestDispatcher rd = httpServletRequest.getRequestDispatcher("/se/ericsson/cf/scott/sandbox/twins/shelf/planexecutionresultlargepreview.jsp");
            httpServletResponse.addHeader(ShelfTwinConstants.HDR_OSLC_VERSION, ShelfTwinConstants.OSLC_VERSION_V2);
            rd.forward(httpServletRequest, httpServletResponse);
        }
