...
<%@page import="eu.scott.warehouse.domains.blocksworld.Location"%>
<%--
...
<%
  Location aLocation = (Location) request.getAttribute("aLocation");
%>
<%--
...
<head>
  ...
  <title><%= aLocation.toString(true) %></title>
...
<div class="container">
    <div class="page-header">
        ...
        <p class="lead">URI:&nbsp;
      <a href="<%= aLocation.getAbout() %>"><%= aLocation.getAbout() %></a>
        </p>
    </div>
        <%--
...
End of user code
        ...
        <div>
          <dl class="row">
            ...
            <dd class="col-sm-9"><%= aLocation.labelToHtml()%></dd>
          </dl>
        </div>
      </div>
    </div>
