...
@OslcName(PddlDomainConstants.FORALL)
@OslcResourceShape(title = "ForAll Resource Shape", describes = PddlDomainConstants.TYPE_FORALL)
public class ForAll
    ...
    implements IForAll
{
    ...
    public static ResourceShape createResourceShape() throws OslcCoreApplicationException, URISyntaxException {
        ...
        PddlDomainConstants.PATH_FORALL,
        ForAll.class);
    }
