...
@OslcName(BworldDomainConstants.LOCATIONORBLOCK)
@OslcResourceShape(title = "location-or-block Resource Shape", describes = BworldDomainConstants.TYPE_LOCATIONORBLOCK)
