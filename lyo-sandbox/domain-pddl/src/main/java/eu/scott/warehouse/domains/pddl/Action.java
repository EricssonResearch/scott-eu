...
@OslcName(PddlDomainConstants.ACTION)
@OslcResourceShape(title = "Action Resource Shape", describes = PddlDomainConstants.TYPE_ACTION)
public class Action
    ...
    implements IAction
{
    ...
    public static ResourceShape createResourceShape() throws OslcCoreApplicationException, URISyntaxException {
        ...
        PddlDomainConstants.PATH_ACTION,
        Action.class);
    }
