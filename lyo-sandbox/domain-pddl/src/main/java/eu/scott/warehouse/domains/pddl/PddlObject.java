...
@OslcName(PddlDomainConstants.PDDLOBJECT)
@OslcResourceShape(title = "Object Resource Shape", describes = PddlDomainConstants.TYPE_PDDLOBJECT)
    ...
    implements IPddlObject
{
    ...
    public static ResourceShape createResourceShape() throws OslcCoreApplicationException, URISyntaxException {
        ...
        PddlDomainConstants.PATH_PDDLOBJECT,
        PddlObject.class);
    }
