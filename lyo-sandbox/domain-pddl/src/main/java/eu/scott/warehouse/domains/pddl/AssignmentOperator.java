...
@OslcName(PddlDomainConstants.ASSIGNMENTOPERATOR)
@OslcResourceShape(title = "AssignmentOperator Resource Shape", describes = PddlDomainConstants.TYPE_ASSIGNMENTOPERATOR)
    ...
    implements IAssignmentOperator
{
    ...
    public static ResourceShape createResourceShape() throws OslcCoreApplicationException, URISyntaxException {
        ...
        PddlDomainConstants.PATH_ASSIGNMENTOPERATOR,
