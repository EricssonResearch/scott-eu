...
@OslcName(PddlDomainConstants.QUANTIFIER)
@OslcResourceShape(title = "Quantifier Resource Shape", describes = PddlDomainConstants.TYPE_QUANTIFIER)
    ...
    implements IQuantifier
{
    ...
    public static ResourceShape createResourceShape() throws OslcCoreApplicationException, URISyntaxException {
        ...
        PddlDomainConstants.PATH_QUANTIFIER,
        Quantifier.class);
    }
