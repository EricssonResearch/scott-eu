...
@OslcName(PddlDomainConstants.PLANEXECUTIONRESULT)
@OslcResourceShape(title = "PlanExecutionResult Resource Shape", describes = PddlDomainConstants.TYPE_PLANEXECUTIONRESULT)
    ...
    implements IPlanExecutionResult
{
    ...
    public static ResourceShape createResourceShape() throws OslcCoreApplicationException, URISyntaxException {
        ...
        PddlDomainConstants.PATH_PLANEXECUTIONRESULT,
    ...
    @OslcRange({PddlDomainConstants.TYPE_PLAN})
    @OslcReadOnly(false)
    public Link getPlan()
    {
