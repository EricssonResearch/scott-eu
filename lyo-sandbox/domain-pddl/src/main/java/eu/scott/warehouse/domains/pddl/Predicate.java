...
@OslcName(PddlDomainConstants.PREDICATE)
@OslcResourceShape(title = "Predicate Resource Shape", describes = PddlDomainConstants.TYPE_PREDICATE)
    ...
    implements IPredicate
{
    ...
    public static ResourceShape createResourceShape() throws OslcCoreApplicationException, URISyntaxException {
        ...
        PddlDomainConstants.PATH_PREDICATE,
        Predicate.class);
    }
