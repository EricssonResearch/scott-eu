...
@OslcName(PddlDomainConstants.EITHERTYPE)
@OslcResourceShape(title = "EitherType Resource Shape", describes = PddlDomainConstants.TYPE_EITHERTYPE)
    ...
    implements IEitherType
{
    ...
    public static ResourceShape createResourceShape() throws OslcCoreApplicationException, URISyntaxException {
        ...
        PddlDomainConstants.PATH_EITHERTYPE,
        EitherType.class);
    }
