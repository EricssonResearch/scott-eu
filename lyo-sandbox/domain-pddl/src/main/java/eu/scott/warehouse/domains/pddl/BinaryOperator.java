...
@OslcName(PddlDomainConstants.BINARYOPERATOR)
@OslcResourceShape(title = "BinaryOperator Resource Shape", describes = PddlDomainConstants.TYPE_BINARYOPERATOR)
    ...
    implements IBinaryOperator
{
    ...
    public static ResourceShape createResourceShape() throws OslcCoreApplicationException, URISyntaxException {
        ...
        PddlDomainConstants.PATH_BINARYOPERATOR,
