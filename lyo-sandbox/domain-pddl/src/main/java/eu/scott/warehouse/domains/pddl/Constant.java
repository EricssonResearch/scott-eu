...
@OslcName(PddlDomainConstants.CONSTANT)
@OslcResourceShape(title = "Constant Resource Shape", describes = PddlDomainConstants.TYPE_CONSTANT)
    ...
    implements IConstant
{
    ...
    public static ResourceShape createResourceShape() throws OslcCoreApplicationException, URISyntaxException {
        ...
        PddlDomainConstants.PATH_CONSTANT,
        Constant.class);
    }
