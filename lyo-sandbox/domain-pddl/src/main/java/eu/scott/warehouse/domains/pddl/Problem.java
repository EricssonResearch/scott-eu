...
@OslcName(PddlDomainConstants.PROBLEM)
@OslcResourceShape(title = "Problem Resource Shape", describes = PddlDomainConstants.TYPE_PROBLEM)
    ...
    implements IProblem
{
    ...
    public static ResourceShape createResourceShape() throws OslcCoreApplicationException, URISyntaxException {
        ...
        PddlDomainConstants.PATH_PROBLEM,
        Problem.class);
    }
