...
@OslcName(PddlDomainConstants.WHEN)
@OslcResourceShape(title = "When Resource Shape", describes = PddlDomainConstants.TYPE_WHEN)
public class When
    ...
    implements IWhen
{
    ...
    public String toString(boolean asLocalResource)
    {
        ...
        if (asLocalResource) {
            result = result + "{a Local When Resource} - update When.toString() to present resource as desired.";
