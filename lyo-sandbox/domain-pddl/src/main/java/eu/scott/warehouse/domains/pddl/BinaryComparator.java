...
@OslcName(PddlDomainConstants.BINARYCOMPARATOR)
@OslcResourceShape(title = "BinaryComparator Resource Shape", describes = PddlDomainConstants.TYPE_BINARYCOMPARATOR)
    ...
    implements IBinaryComparator
{
    ...
    public static ResourceShape createResourceShape() throws OslcCoreApplicationException, URISyntaxException {
        ...
        PddlDomainConstants.PATH_BINARYCOMPARATOR,
