...
@OslcName(PddlDomainConstants.FLUENTMINUS)
@OslcResourceShape(title = "FluentMinus Resource Shape", describes = PddlDomainConstants.TYPE_FLUENTMINUS)
    ...
    implements IFluentMinus
{
    ...
    public static ResourceShape createResourceShape() throws OslcCoreApplicationException, URISyntaxException {
        ...
        PddlDomainConstants.PATH_FLUENTMINUS,
        FluentMinus.class);
    }
