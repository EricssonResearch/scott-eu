...
RUN echo "2019-07-11 19:55 CEST"
...
RUN git clone --depth=1 --branch=master https://github.com/eclipse/lyo.core.git && cd lyo.core/oslc4j-core-build && mvn clean install -Dmaven.test.skip=true -B -q
