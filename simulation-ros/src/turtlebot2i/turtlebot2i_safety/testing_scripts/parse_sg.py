...
def init_RA():
    #Prepare some static components of FLS
    global object_type,object_direction,object_speed,object_orientation
...
def setup_RA(robot_speed):
    ...
    rule2 = ctrl.Rule(object_distance['average'], risk['average'])
