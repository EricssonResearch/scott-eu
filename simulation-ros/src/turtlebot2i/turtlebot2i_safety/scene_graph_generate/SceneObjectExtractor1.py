...
class SceneObjectExtractor:
    def __init__(self, ip, port):
        ...
        self.dynamic_obj_name_list = ['Bill', 'Bill#2', 'product']
        self.robot_name_list = ['turtlebot2i', 'turtlebot2i#0', 'turtlebot2i#1']
        '''
        self.static_obj_name_list  = ['stairs', 'slidingDoor',
                                      'DockStationBody', 'DockStationBody#0',\
                                      'ConveyorBeltBody', 'ConveyorBeltBody#0', 'ConveyorBeltBody#1',\
        ...
        self.dynamic_obj_name_list = ['Bill#3']
    ...
    # try to close Vrep connection, but didnot work
