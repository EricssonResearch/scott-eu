...
# functions
quality = ctrl.Antecedent(np.arange(0, 11, 1), 'quality')   # We can have a larger input: No range check needed.
...
tip['medium1'] =fuzz.trimf(tip.universe, [0, 13, 15])#fuzz.gaussmf(tip.universe,13,1)
tip['medium2'] =fuzz.trimf(tip.universe, [15, 19, 25])#fuzz.gaussmf(tip.universe,3,1)
null,tip['medium'] = fuzz.fuzzy_or(x,tip['medium1'],x,tip['medium2']) 
#fuzz.gauss2mf(tip.universe,3,1,20,1)    #fuzz.gaussmf(tip.universe,13,3)#fuzz.trimf(tip.universe, [0, 13, 25])
