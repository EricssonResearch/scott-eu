...
class ReinforceAgent():
    def __init__(self, state_size, action_size):
        ...
        self.dirPath = self.dirPath.replace('scott-eu/simulation-ros/src/turtlebot2i/turtlebot2i_safety/src', 'scott-eu/simulation-ros/src/turtlebot2i/turtlebot2i_safety/src/models/dqn_')
        self.result = Float32MultiArray()

        self.load_model = True
        self.load_episode = 885#340 #0
...
if __name__ == '__main__':
    try:
        ...
        if training_mode:
            ...
            prev_action = 0
            time_duration_list = []
            #rospy.Subscriber('/turtlebot2i/safety/obstacles_risk', SafetyRisk, prediction_callback)
            #rospy.spin()
            #'''
            while True:
                data = None
                ...
                if data == None:
                    ...
                    if len(time_duration_list) == 100:
                        np.savez('/home/turtlebot/thesis2019/duration_result/time_duration_rm_dqn.npz', time_duration_list=time_duration_list)
