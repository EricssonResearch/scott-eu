...
from environment_cnn import Env
...
class ReinforceAgent():
    def __init__(self, env, training_mode):
        ...
        self.dirPath = self.dirPath.replace('scott-eu/simulation-ros/src/turtlebot2i/turtlebot2i_safety/src', 'scott-eu/simulation-ros/src/turtlebot2i/turtlebot2i_safety/src/models/cnn_')
    ...
    def prediction_callback(self, data):
        if len(self.state_stack) < self.stack_len:
            ...
            #     savePath = self.dirPath.replace('scott-eu/simulation-ros/src/turtlebot2i/turtlebot2i_safety/src', 'time_duration/time_duration_rm_cnn.npz')
