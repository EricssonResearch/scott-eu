...
def init_risk_mitigation():
    ...
    mitigation_rule_list = rule_list_generator(object_distance, object_direction, object_risk_input, left_speed,
                                               right_speed)
...
def risk_callback(data):
    ...
    #    savePath = self.dirPath.replace('scott-eu/simulation-ros/src/turtlebot2i/turtlebot2i_safety/src', 'time_duration/time_duration_rm_fls.npz')
...
if __name__ == '__main__':
    try:
        ...
        safe_vel_pub = rospy.Publisher('safety/vel_scale', VelocityScale, queue_size=10)
        rospy.Subscriber('safety/obstacles_risk', SafetyRisk, risk_callback)
