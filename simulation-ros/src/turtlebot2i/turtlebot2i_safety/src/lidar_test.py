...
def move_random(x_size, y_size):
    ...
    goal.target_pose.pose.position.x = np.random.uniform(low=robot_diameter, high=x_size-robot_diameter)
    goal.target_pose.pose.position.y = np.random.uniform(low=robot_diameter, high=y_size-robot_diameter)
