...
class RPN(nn.Module):
    ...
    def build_loss(self, rpn_cls_score_reshape, rpn_bbox_pred, rpn_data, is_region=False):
        ...
        #print 'rpn_bbox_pred type: ', rpn_bbox_pred, rpn_bbox_pred.dtype, rpn_bbox_pred.shape
        #print 'rpn_bbox_targets type: ', rpn_bbox_targets, rpn_bbox_targets.dtype, rpn_bbox_targets.shape
        #print 'fg_cnt : ', fg_cnt, fg_cnt.dtype
        fg_cnt = fg_cnt.float()

        #print 'temp_rpn type: ', temp_rpn, temp_rpn.dtype, temp_rpn.shape
