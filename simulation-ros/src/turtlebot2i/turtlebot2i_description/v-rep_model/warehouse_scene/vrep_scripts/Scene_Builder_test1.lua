...
function sysCall_init()
    ...
    addModel('turtlebot2i',{-4.5,-3.5,0.063},{0,0,math.pi/2}) --TODO: check why the robot is moving by itself
    --addModel('turtlebot2i',{-2.0, -2.5,0.063},{0,0,0}) --TODO: check why the robot is moving by itself
