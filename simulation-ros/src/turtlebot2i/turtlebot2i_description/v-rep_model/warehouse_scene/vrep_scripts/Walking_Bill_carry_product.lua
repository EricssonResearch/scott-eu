function sysCall_init() 
    ...
    productHandle=sim.getObjectHandle('carried_product')
    ...
    if (randomColors) then
        ...
        result1=sim.setShapeColor(productHandle,nil,0,{math.random(),math.random(),math.random()})
        --setColor(modelObjects,'carried_product',shirtColors[1+math.random(shirtColors[1])])
        --printf("result1=%2.2f, productHandle=%2.2f ",result1,productHandle)
    end
...
function sysCall_actuation() 
    ...
    if (movement==0) then
            ...
            rightShoulderJointValue=0.0--(shoulderWaypoints[oppIndexLow+1]*(1-t)+shoulderWaypoints[oppIndexHigh+1]*t)*scaling
            rightElbowJointValue=0.0--(elbowWaypoints[oppIndexLow+1]*(1-t)+elbowWaypoints[oppIndexHigh+1]*t)*scaling
    		--printf("rightShoulderJointValue=%2.2f,rightElbowJointValue=%2.2f ",rightShoulderJointValue,rightElbowJointValue)
