...
function sysCall_init()
    ...
    addModel('80cmHighPillar100cm', {-10,-10,0.4}, {0,0,0})
    addModel('80cmHighPillar100cm', {10,10,0.4}, {0,0,0})
    addModel('ConcreteBox2', {8.2,-9.425,0.5}, {0,0,0})
    ...
    addModel('ConcreteBox', {11.075,4.35,0.5}, {0,0,0})
    ...
    addModel('ConcreteBox2', {-8.175,-8.9,0.5}, {0,0,0})
    addModel('ConcreteBox2', {-6.225,-9.025,0.5}, {0,0,0})
    addModel('ConcreteBox3', {-6.775,-7.325,0.5}, {0,0,0})
    addModel('ConcreteBox', {-9.9,-3.35,0.5}, {0,0,0})
    addModel('ConcreteBox', {-7.35,-1.3,0.5}, {0,0,0})
    addModel('ConcreteBox2', {-9.9,-1.2,0.5}, {0,0,0})
    addModel('ConcreteBox', {-14.15,2.95,0.5}, {0,0,0})
    addModel('ConcreteBox2', {-11.925,3.9,0.5}, {0,0,0})
    ...
    addModel('dockstation', {7,6,0.052}, {0,0,math.pi})
    addModel('dockstation', {9,6,0.052}, {0,0,math.pi})
...
--     addModel('turtlebot2i_edge', {9,7,0.063}, {0,0,math.pi/2})
    ...
    addModel('Walking_Bill', {10,-7.5,0}, {0,0,math.pi})
    addModel('Standing_Bill', {-6.1,-2.225,0}, {0,0,0})
