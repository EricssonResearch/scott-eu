...
function sysCall_init()
	...
	addModel('Shelf',{1.9,0.96485,0.063},{0,0,-math.pi/2}) -- TODO: check why shelf rotation here is not compatible with what happens in the sim
	addModel('Shelf',{1.1,-0.53515,0.063},{0,0,-math.pi/2})
	addModel('Shelf',{1.9,-2.0351,0.063},{0,0,-math.pi/2})


	addModel('ConveyorBelt',{4.3750,2.4649,0.113},{0,0,0}) -- TODO: check why we need to add these values in z
	addModel('ConveyorBelt',{3.3750,-0.53515,0.113},{0,0,0})
	...
	addModel('turtlebot2i',{2.2230,2.96485,0.063},{0,0,-math.pi/2}) --TODO: check why the robot is moving by itself
