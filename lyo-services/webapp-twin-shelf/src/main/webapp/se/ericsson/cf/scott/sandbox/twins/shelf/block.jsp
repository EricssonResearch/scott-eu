...
<%@page import="eu.scott.warehouse.domains.blocksworld.Block"%>
<%--
...
<%
  Block aBlock = (Block) request.getAttribute("aBlock");
%>
<%--
...
<head>
  ...
  <title><%= aBlock.toString(true) %></title>
...
<div class="container">
    <div class="page-header">
        <h1>block resource</h1>
        <p class="lead">URI:&nbsp;
      <a href="<%= aBlock.getAbout() %>"><%= aBlock.getAbout() %></a>
        </p>
    </div>
        <%--
...
End of user code
        ...
        <div>
          <dl class="row">
            ...
            <dd class="col-sm-9"><%= aBlock.labelToHtml()%></dd>
          </dl>
        </div>
      </div>
    </div>
