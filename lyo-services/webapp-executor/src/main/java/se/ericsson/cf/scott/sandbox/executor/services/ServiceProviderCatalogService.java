...
package se.ericsson.cf.scott.sandbox.executor.services;
...
public class ServiceProviderCatalogService
{
    ...
    public ServiceProviderCatalog getServiceProviderCatalog()
    {
        ...
        if (catalog != null) {
            httpServletResponse.addHeader(PlanExecutorConstants.HDR_OSLC_VERSION,"2.0");
            return catalog;
        }
    ...
    public void getHtmlServiceProvider(@PathParam("someId") final String someId)
    {
        ...
        if (catalog !=null )
        {
            ...
            RequestDispatcher rd = httpServletRequest.getRequestDispatcher("/se/ericsson/cf/scott/sandbox/executor/serviceprovidercatalog.jsp");
            try {
