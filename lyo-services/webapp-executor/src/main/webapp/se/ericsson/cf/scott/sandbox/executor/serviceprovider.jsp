...
<body>
  ...
  <nav class="navbar sticky-top navbar-light bg-light">
    <div class="container">
      <a class="navbar-brand" href="<c:url value="/services/catalog/singleton"/>">PlanExecutor</a>
    </div>
  </nav>
  ...
  <div class="container">
    ...
    (<a href="<%= request.getContextPath() %>/se/ericsson/cf/scott/sandbox/executor/selectiondialogsampleclient.jsp?selectionUri=<%= URLEncoder.encode(selectionDialog.toString(), "UTF-8") %>">sample client</a>)
    </p>
    <%}%>
    ...
    (<a href="<%= request.getContextPath() %>/se/ericsson/cf/scott/sandbox/executor/creationdialogsampleclient.jsp?creationUri=<%= URLEncoder.encode(creationDialog.toString(), "UTF-8") %>">sample client</a>)
    </p>
    <%}%>
