...
--%>
<%@page import="eu.scott.warehouse.domains.scott.ExecutableAction"%>
<%@page import="java.net.URI"%>
<%
String asLocalResource = request.getParameter("asLocalResource");
ExecutableAction aResource = null;
if (request.getAttribute("aExecutableAction") != null) {
    aResource = (ExecutableAction) request.getAttribute("aExecutableAction");
}
else {
    if (request.getParameter("resourceUri") != null) {
        aResource = new ExecutableAction (new URI(request.getParameter("resourceUri")));
    }
}

if (asLocalResource != null && asLocalResource.equalsIgnoreCase("true")) {
    out.write("{a Local ExecutableAction Resource} - update ExecutableAction.toString() to present resource as desired.");
}
else {
    if (aResource == null) {
