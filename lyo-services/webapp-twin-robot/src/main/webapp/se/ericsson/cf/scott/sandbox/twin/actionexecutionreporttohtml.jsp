...
if (request.getAttribute("aActionExecutionReport") != null) {
    aResource = (ActionExecutionReport) request.getAttribute("aActionExecutionReport");
}
else {
    if (request.getParameter("resourceUri") != null) {
        aResource = new ActionExecutionReport (new URI(request.getParameter("resourceUri")));
    }
}

if (asLocalResource != null && asLocalResource.equalsIgnoreCase("true")) {
    out.write("{a Local ActionExecutionReport Resource} - update ActionExecutionReport.toString() to present resource as desired.");
}
else {
    if (aResource == null) {
