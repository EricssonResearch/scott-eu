...
--%>
<%@page import="eu.scott.warehouse.domains.pddl.Step"%>
<%@page import="java.net.URI"%>
<%
String asLocalResource = request.getParameter("asLocalResource");
Step aResource = null;
if (request.getAttribute("aStep") != null) {
    aResource = (Step) request.getAttribute("aStep");
}
else {
    if (request.getParameter("resourceUri") != null) {
        aResource = new Step (new URI(request.getParameter("resourceUri")));
    }
}

if (asLocalResource != null && asLocalResource.equalsIgnoreCase("true")) {
    out.write("{a Local Step Resource} - update Step.toString() to present resource as desired.");
}
else {
    if (aResource == null) {
