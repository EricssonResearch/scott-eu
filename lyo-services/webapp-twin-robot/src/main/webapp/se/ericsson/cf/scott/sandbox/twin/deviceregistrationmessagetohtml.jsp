...
--%>
<%@page import="eu.scott.warehouse.domains.twins.DeviceRegistrationMessage"%>
<%@page import="java.net.URI"%>
<%
String asLocalResource = request.getParameter("asLocalResource");
DeviceRegistrationMessage aResource = null;
if (request.getAttribute("aDeviceRegistrationMessage") != null) {
    aResource = (DeviceRegistrationMessage) request.getAttribute("aDeviceRegistrationMessage");
}
else {
    if (request.getParameter("resourceUri") != null) {
        aResource = new DeviceRegistrationMessage (new URI(request.getParameter("resourceUri")));
    }
}

if (asLocalResource != null && asLocalResource.equalsIgnoreCase("true")) {
    out.write("{a Local DeviceRegistrationMessage Resource} - update DeviceRegistrationMessage.toString() to present resource as desired.");
}
else {
    if (aResource == null) {
