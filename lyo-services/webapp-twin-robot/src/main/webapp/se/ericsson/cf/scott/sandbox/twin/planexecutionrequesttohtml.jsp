...
--%>
<%@page import="eu.scott.warehouse.domains.twins.PlanExecutionRequest"%>
<%@page import="java.net.URI"%>
<%
String asLocalResource = request.getParameter("asLocalResource");
PlanExecutionRequest aResource = null;
if (request.getAttribute("aPlanExecutionRequest") != null) {
    aResource = (PlanExecutionRequest) request.getAttribute("aPlanExecutionRequest");
}
else {
    if (request.getParameter("resourceUri") != null) {
        aResource = new PlanExecutionRequest (new URI(request.getParameter("resourceUri")));
    }
}

if (asLocalResource != null && asLocalResource.equalsIgnoreCase("true")) {
    out.write("{a Local PlanExecutionRequest Resource} - update PlanExecutionRequest.toString() to present resource as desired.");
}
else {
    if (aResource == null) {
