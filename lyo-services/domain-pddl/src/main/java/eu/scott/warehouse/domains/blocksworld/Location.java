...
// End of user code
@OslcNamespace(BworldDomainConstants.LOCATION_NAMESPACE)
@OslcName(BworldDomainConstants.LOCATION_LOCALNAME)
@OslcResourceShape(title = "location Resource Shape", describes = BworldDomainConstants.LOCATION_TYPE)
    ...
    implements ILocation
{
    ...
    public static ResourceShape createResourceShape() throws OslcCoreApplicationException, URISyntaxException {
        ...
        BworldDomainConstants.LOCATION_PATH,
        Location.class);
    }
