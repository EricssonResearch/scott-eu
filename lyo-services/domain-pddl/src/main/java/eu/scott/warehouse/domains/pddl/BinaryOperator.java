...
// End of user code
@OslcNamespace(PddlDomainConstants.BINARYOPERATOR_NAMESPACE)
@OslcName(PddlDomainConstants.BINARYOPERATOR_LOCALNAME)
@OslcResourceShape(title = "BinaryOperator Resource Shape", describes = PddlDomainConstants.BINARYOPERATOR_TYPE)
    ...
    implements IBinaryOperator
{
    ...
    public BinaryOperator(final URI about)
           throws URISyntaxException
    {
        super(about);
    ...
    public static ResourceShape createResourceShape() throws OslcCoreApplicationException, URISyntaxException {
        ...
        PddlDomainConstants.BINARYOPERATOR_PATH,
    ...
    public String toString(boolean asLocalResource)
    {
        ...
        if (asLocalResource) {
            result = result + "{a Local BinaryOperator Resource} - update BinaryOperator.toString() to present resource as desired.";
