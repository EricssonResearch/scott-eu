    ...
    implements ICompositeSelector
{
    ...
    public static ResourceShape createResourceShape() throws OslcCoreApplicationException, URISyntaxException {
        ...
        MissionDomainConstants.COMPOSITESELECTOR_PATH,
        CompositeSelector.class);
    }
    ...
    public String toString(boolean asLocalResource)
    {
        ...
        if (asLocalResource) {
            result = result + "{a Local CompositeSelector Resource} - update CompositeSelector.toString() to present resource as desired.";
