    ...
    implements IForAll
{
    ...
    public static ResourceShape createResourceShape() throws OslcCoreApplicationException, URISyntaxException {
        ...
        PddlDomainConstants.FORALL_PATH,
        ForAll.class);
    }
    ...
    public String toString(boolean asLocalResource)
    {
        ...
        if (asLocalResource) {
            result = result + "{a Local ForAll Resource} - update ForAll.toString() to present resource as desired.";
