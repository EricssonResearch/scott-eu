...
// End of user code
@OslcNamespace(PddlDomainConstants.NOT_NAMESPACE)
@OslcName(PddlDomainConstants.NOT_LOCALNAME)
@OslcResourceShape(title = "Not Resource Shape", describes = PddlDomainConstants.NOT_TYPE)
public class Not
    ...
    implements INot
{
    ...
    public String toString(boolean asLocalResource)
    {
        ...
        if (asLocalResource) {
            result = result + "{a Local Not Resource} - update Not.toString() to present resource as desired.";
