...
// End of user code
@OslcNamespace(PddlDomainConstants.OR_NAMESPACE)
@OslcName(PddlDomainConstants.OR_LOCALNAME)
@OslcResourceShape(title = "Or Resource Shape", describes = PddlDomainConstants.OR_TYPE)
public class Or
    ...
    implements IOr
{
    ...
    // End of user code
    public void setArgument(@NonNull final Set<Link> argument )
    {
