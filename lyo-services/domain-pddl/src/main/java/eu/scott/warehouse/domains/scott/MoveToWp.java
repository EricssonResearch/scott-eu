...
// End of user code
@OslcNamespace(ScottDomainConstants.MOVE_TO_WP_NAMESPACE)
    ...
    implements IMoveToWp
{
    ...
    public static ResourceShape createResourceShape() throws OslcCoreApplicationException, URISyntaxException {
        ...
        ScottDomainConstants.MOVE_TO_WP_PATH,
        MoveToWp.class);
    }
    ...
    public String toString(boolean asLocalResource)
    {
        ...
        if (asLocalResource) {
            result = result + "{a Local Move-to-wp Resource} - update Move-to-wp.toString() to present resource as desired.";
