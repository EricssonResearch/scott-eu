...
// End of user code
@OslcNamespace(PddlDomainConstants.ACTION_NAMESPACE)
@OslcName(PddlDomainConstants.ACTION_LOCALNAME)
@OslcResourceShape(title = "Action Resource Shape", describes = PddlDomainConstants.ACTION_TYPE)
public class Action
    ...
    implements IAction
{
    ...
    public static ResourceShape createResourceShape() throws OslcCoreApplicationException, URISyntaxException {
        ...
        PddlDomainConstants.ACTION_PATH,
        Action.class);
    }
    ...
    // End of user code
    public void setEffect(final Link effect )
    {
    ...
    public String effectToHtml()
    {
        ...
        try {
            if ((effect == null) || (effect.getValue() == null)) {
                s = s + "<em>null</em>";
            }
            else {
                s = s + effect.getValue().toString();
            }
        } catch (Exception e) {
            e.printStackTrace();
        }
    ...
    public String preconditionToHtml()
    {
        ...
        try {
            if ((precondition == null) || (precondition.getValue() == null)) {
                ...
                s = s + precondition.getValue().toString();
            }
        } catch (Exception e) {
            e.printStackTrace();
        }
