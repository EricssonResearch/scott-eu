...
// End of user code
@OslcNamespace(BworldDomainConstants.LOCATION_OR_BLOCK_NAMESPACE)
@OslcName(BworldDomainConstants.LOCATION_OR_BLOCK_LOCALNAME)
@OslcResourceShape(title = "location-or-block Resource Shape", describes = BworldDomainConstants.LOCATION_OR_BLOCK_TYPE)
public class LocationOrBlock
    extends EitherType
    implements ILocationOrBlock
{
    ...
    public static ResourceShape createResourceShape() throws OslcCoreApplicationException, URISyntaxException {
        ...
        BworldDomainConstants.LOCATION_OR_BLOCK_PATH,
