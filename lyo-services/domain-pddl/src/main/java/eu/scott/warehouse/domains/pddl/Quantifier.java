...
// End of user code
@OslcNamespace(PddlDomainConstants.QUANTIFIER_NAMESPACE)
@OslcName(PddlDomainConstants.QUANTIFIER_LOCALNAME)
@OslcResourceShape(title = "Quantifier Resource Shape", describes = PddlDomainConstants.QUANTIFIER_TYPE)
    ...
    implements IQuantifier
{
    ...
    public static ResourceShape createResourceShape() throws OslcCoreApplicationException, URISyntaxException {
        ...
        PddlDomainConstants.QUANTIFIER_PATH,
        Quantifier.class);
    }
    ...
    public String toString(boolean asLocalResource)
    {
        ...
        if (asLocalResource) {
            result = result + "{a Local Quantifier Resource} - update Quantifier.toString() to present resource as desired.";
