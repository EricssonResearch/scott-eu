...
// End of user code
@OslcNamespace(MissionDomainConstants.GOAL_NAMESPACE)
@OslcName(MissionDomainConstants.GOAL_LOCALNAME)
@OslcResourceShape(title = "Goal Resource Shape", describes = MissionDomainConstants.GOAL_TYPE)
public class Goal
    ...
    implements IGoal
{
    ...
    public static ResourceShape createResourceShape() throws OslcCoreApplicationException, URISyntaxException {
        ...
        MissionDomainConstants.GOAL_PATH,
        Goal.class);
    }
