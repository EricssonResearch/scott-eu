...
// End of user code
@OslcNamespace(PddlDomainConstants.IMPLY_NAMESPACE)
@OslcName(PddlDomainConstants.IMPLY_LOCALNAME)
@OslcResourceShape(title = "Imply Resource Shape", describes = PddlDomainConstants.IMPLY_TYPE)
public class Imply
    ...
    implements IImply
{
    ...
    public static ResourceShape createResourceShape() throws OslcCoreApplicationException, URISyntaxException {
        ...
        PddlDomainConstants.IMPLY_PATH,
        Imply.class);
    }
    ...
    public String toString(boolean asLocalResource)
    {
        ...
        if (asLocalResource) {
            result = result + "{a Local Imply Resource} - update Imply.toString() to present resource as desired.";
