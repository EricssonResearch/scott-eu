...
// End of user code
@OslcNamespace(PddlDomainConstants.BINARYCOMPARATOR_NAMESPACE)
@OslcName(PddlDomainConstants.BINARYCOMPARATOR_LOCALNAME)
@OslcResourceShape(title = "BinaryComparator Resource Shape", describes = PddlDomainConstants.BINARYCOMPARATOR_TYPE)
    ...
    implements IBinaryComparator
{
    ...
    public BinaryComparator(final URI about)
           throws URISyntaxException
    {
        super(about);
    ...
    public static ResourceShape createResourceShape() throws OslcCoreApplicationException, URISyntaxException {
        ...
        PddlDomainConstants.BINARYCOMPARATOR_PATH,
    ...
    public String toString(boolean asLocalResource)
    {
        ...
        if (asLocalResource) {
            result = result + "{a Local BinaryComparator Resource} - update BinaryComparator.toString() to present resource as desired.";
