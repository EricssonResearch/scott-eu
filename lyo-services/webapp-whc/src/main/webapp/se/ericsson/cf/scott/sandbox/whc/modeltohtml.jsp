...
Model aResource = null;
if (request.getAttribute("aModel") != null) {
    aResource = (Model) request.getAttribute("aModel");
}
else {
    if (request.getParameter("resourceUri") != null) {
        aResource = new Model (new URI(request.getParameter("resourceUri")));
    }
}

if (asLocalResource != null && asLocalResource.equalsIgnoreCase("true")) {
    out.write("{a Local Model Resource} - update Model.toString() to present resource as desired.");
}
else {
    if (aResource == null) {
