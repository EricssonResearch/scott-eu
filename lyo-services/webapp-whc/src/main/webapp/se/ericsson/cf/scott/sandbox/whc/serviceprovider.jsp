...
<body>
  ...
  <div class="container">
    ...
    (<a href="<%= request.getContextPath() %>/se/ericsson/cf/scott/sandbox/whc/selectiondialogsampleclient.jsp?selectionUri=<%= URLEncoder.encode(selectionDialog.toString(), "UTF-8") %>">sample client</a>)
    </p>
    <%}%>
    ...
    (<a href="<%= request.getContextPath() %>/se/ericsson/cf/scott/sandbox/whc/creationdialogsampleclient.jsp?creationUri=<%= URLEncoder.encode(creationDialog.toString(), "UTF-8") %>">sample client</a>)
    </p>
    <%}%>
