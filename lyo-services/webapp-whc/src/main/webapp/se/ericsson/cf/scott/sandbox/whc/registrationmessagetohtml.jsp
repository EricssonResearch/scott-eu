...
--%>
<%@page import="eu.scott.warehouse.domains.twins.RegistrationMessage"%>
<%@page import="java.net.URI"%>
<%
String asLocalResource = request.getParameter("asLocalResource");
RegistrationMessage aResource = null;
if (request.getAttribute("aRegistrationMessage") != null) {
    aResource = (RegistrationMessage) request.getAttribute("aRegistrationMessage");
}
else {
    if (request.getParameter("resourceUri") != null) {
        aResource = new RegistrationMessage (new URI(request.getParameter("resourceUri")));
    }
}

if (asLocalResource != null && asLocalResource.equalsIgnoreCase("true")) {
    out.write("{a Local RegistrationMessage Resource} - update RegistrationMessage.toString() to present resource as desired.");
}
else {
    if (aResource == null) {
