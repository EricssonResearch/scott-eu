...
<%
  Model aModel = (Model) request.getAttribute("aModel");
%>
<html lang="en">
<head>
  <meta charset="utf-8">
...
<div class="container">
    <div class="page-header">
        <h1>Model resource</h1>
        <p class="lead">URI:&nbsp;
        <jsp:include page="/se/ericsson/cf/scott/sandbox/whc/modeltohtml.jsp"></jsp:include>
        </p>
    </div>
        <h2>Properties</h2>
