...
@OslcName(PddlDomainConstants.PRIMITIVETYPE)
@OslcResourceShape(title = "PrimitiveType Resource Shape", describes = PddlDomainConstants.TYPE_PRIMITIVETYPE)
    ...
    implements IPrimitiveType
{
    ...
    public static ResourceShape createResourceShape() throws OslcCoreApplicationException, URISyntaxException {
        ...
        PddlDomainConstants.PATH_PRIMITIVETYPE,
        PrimitiveType.class);
    }
    ...
    public String toString(boolean asLocalResource)
    {
        ...
        if (asLocalResource) {
            result = result + "{a Local PrimitiveType Resource} - update PrimitiveType.toString() to present resource as desired.";
