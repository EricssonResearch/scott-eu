...
@Path("independent")
public class IndependentServiceProviderService
{
    ...
    {
        httpServletResponse.addHeader("Oslc-Core-Version","2.0");
        return ServiceProviderCatalogSingleton.getIndependentServiceProvider(httpServletRequest, serviceProviderId);
    }
    ...
    {
        ServiceProvider serviceProvider = ServiceProviderCatalogSingleton.getIndependentServiceProvider(httpServletRequest, serviceProviderId);
        ...
        RequestDispatcher rd = httpServletRequest.getRequestDispatcher("/se/ericsson/cf/scott/sandbox/twin/independentserviceprovider.jsp");
        try {
