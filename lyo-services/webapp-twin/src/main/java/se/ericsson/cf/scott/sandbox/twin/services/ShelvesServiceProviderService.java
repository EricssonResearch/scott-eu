...
@Path("shelves")
public class ShelvesServiceProviderService
{
    ...
    {
        httpServletResponse.addHeader("Oslc-Core-Version","2.0");
        return ServiceProviderCatalogSingleton.getShelvesServiceProvider(httpServletRequest, serviceProviderId);
    }
    ...
    {
        ServiceProvider serviceProvider = ServiceProviderCatalogSingleton.getShelvesServiceProvider(httpServletRequest, serviceProviderId);
        ...
        RequestDispatcher rd = httpServletRequest.getRequestDispatcher("/se/ericsson/cf/scott/sandbox/twin/shelvesserviceprovider.jsp");
        try {
