...
@Path("robots")
public class RobotsServiceProviderService
{
    ...
    {
        httpServletResponse.addHeader("Oslc-Core-Version","2.0");
        return ServiceProviderCatalogSingleton.getRobotsServiceProvider(httpServletRequest, serviceProviderId);
    }
    ...
    {
        ServiceProvider serviceProvider = ServiceProviderCatalogSingleton.getRobotsServiceProvider(httpServletRequest, serviceProviderId);
        ...
        RequestDispatcher rd = httpServletRequest.getRequestDispatcher("/se/ericsson/cf/scott/sandbox/twin/robotsserviceprovider.jsp");
        try {
