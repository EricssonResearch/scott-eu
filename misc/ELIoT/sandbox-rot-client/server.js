...
// Command line Access, In case we need boot strap in the future.
...
// Update
/**
 * Set lifetime, version attributes to the Smart Object
 * @param attrs
 */
...
// Factory reset
/**
 * Hard Reset of all SmartObjects.
 * @param callback
 */
...
/**
 * Read latitude and longitude information from the Smart Object
 * @param mode '-t' for non-bootstraping mode, '-b' for bootstraping mode
 */
function Read_coordinate(mode) {
  if (mode === '-t')  {
...
/**
 * Renew the corrdinate value
 * @param mode service working mode: '-t' for non-bootstrap and '-b' for bootstraping.
 * @param timestep Refresh period, default 50000.
 */
function Refresh_coordinate(mode = "-t", timestep = 5000){
  RefreshStep = setInterval(Read_coordinate, timestep, mode);
  }
